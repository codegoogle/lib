...
public class ToponNativeSmallTop implements ATNativeAdRenderer<CustomNativeAd> {
    ...
    public ToponNativeSmallTop(Activity context, String mdirection) {
    ...
    public View createView(Context context, int i) {
        if (this.mDevelopView == null) {
            this.mDevelopView = LayoutInflater.from(context).inflate(R.layout.ads_native_topon_small_top, (ViewGroup) null);
        }
