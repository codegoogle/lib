...
public class ToponNativeSmallBanner implements ATNativeAdRenderer<CustomNativeAd> {
    ...
    public ToponNativeSmallBanner(Activity context) {
    ...
    public View createView(Context context, int i) {
        if (this.mDevelopView == null) {
            this.mDevelopView = LayoutInflater.from(context).inflate(R.layout.ads_native_topon_banner, (ViewGroup) null);
