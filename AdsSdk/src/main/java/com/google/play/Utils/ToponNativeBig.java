...
public class ToponNativeBig implements ATNativeAdRenderer<CustomNativeAd> {
    ...
    public ToponNativeBig(Activity context, String mdirection) {
    ...
    public View createView(Context context, int i) {
        if (this.mDevelopView == null) {
            if (MyApp.getString(Const.ads_btn).equals("1")) {
                this.mDevelopView = LayoutInflater.from(context).inflate(R.layout.ads_nativ_topon_big_card, (ViewGroup) null);

                CardView card = mDevelopView.findViewById(R.id.card);
                TextView ad_headline = mDevelopView.findViewById(R.id.native_ad_title);
                TextView ad_body = mDevelopView.findViewById(R.id.native_ad_desc);
                ...
                this.mDevelopView = LayoutInflater.from(context).inflate(R.layout.ads_nativ_topon_big_card_custome, (ViewGroup) null);
            }
        }
