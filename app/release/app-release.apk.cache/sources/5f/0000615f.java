...
public final class v93 extends q93 {
    ...
    public v93(@NotNull q13 q13Var, @NotNull n13<?> n13Var, @NotNull StaticNativeAd staticNativeAd) {
    ...
    public void f() {
        if (yz2.a.e(p())) {
            ...
            p().setContentView(b03.k.Y);
            p().findViewById(b03.h.x1).setVisibility(8);
        }
        super.f();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v93(@NotNull q13 q13Var, @NotNull n13<?> n13Var, @NotNull VideoNativeAd videoNativeAd) {
