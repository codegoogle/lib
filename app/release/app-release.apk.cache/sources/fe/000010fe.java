...
public abstract class G8 implements Q1 {
    ...
    public static void A01() {
        A01 = new byte[]{89, 123, 123, 125, -120, -116, 69, 91, g15.b, 121, -118, -117, 125, -116, -98, -67, -49, -59, -65, -82, -63, -51, -47, -63, -49, -48, -92, -67, -54, -64, -56, -63, -50, -118, -53, -54, -95, -50, -50, -53, -50, 124, -61, -53, -48, -102, -58, -59, -53, -68, -59, -53, -124, -85, -48, -57, -68, -71, -72, -86, -111, -100};
    }
    ...
    public final boolean A9Z(C0919Pz c0919Pz) {
        InterfaceC0905Pl A00 = c0919Pz.A00();
        if (this.A00.A7f()) {
            this.A00.A7u(A00(14, 31, 78));
            c0919Pz.printStackTrace();
        }
        if (A00 != null && A00.A74() > 0) {
            return true;
        }
        return false;
    }
    ...
    @Override // com.facebook.ads.redexgen.X.Q1
    public final void ABk(HttpURLConnection httpURLConnection, EnumC0917Px enumC0917Px, String str) throws IOException {
        httpURLConnection.setRequestMethod(enumC0917Px.A03());
        httpURLConnection.setDoOutput(enumC0917Px.A05());
        httpURLConnection.setDoInput(enumC0917Px.A04());
        if (str != null) {
