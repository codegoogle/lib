...
public class a {
    ...
    private final HashMap<View, C0106a> b = new HashMap<>();
    ...
    public static class C0106a {
        ...
        public C0106a(com.iab.omid.library.ironsrc.b.c cVar, String str) {
            this.a = cVar;
            a(str);
        }
    ...
    private void a(com.iab.omid.library.ironsrc.b.c cVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        C0106a c0106a = this.b.get(view);
        if (c0106a != null) {
            c0106a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0106a(cVar, aVar.getAdSessionId()));
        }
    }
