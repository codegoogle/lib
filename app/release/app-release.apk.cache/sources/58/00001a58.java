...
public final class zaaa extends Button {
    public zaaa(Context context, @z1 AttributeSet attributeSet) {
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        Drawable r = fk.r(resources.getDrawable(zab));
        fk.o(r, resources.getColorStateList(R.color.common_google_signin_btn_tint));
        fk.p(r, PorterDuff.Mode.SRC_ATOP);
