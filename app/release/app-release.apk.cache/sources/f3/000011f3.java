...
public final class KB {
    ...
    public static void A04() {
        A03 = new byte[]{-35, 43, -14, -35, 43, -14, -35, 43, -14, -35, 28, -14, -35, 28, -14, -35, 28, -26, -19, -26, 24, 23, -26, -28, 26, -20, 10, 0, 5, -2, -73, 3, -8, 10, Flags.CD, -73, -8, -5, -73, 9, -4, 10, 7, 6, 5, 10, -4, 5, 3, 18, -22, -1, 17, 18, -16, 3, 17, 14, 13, 12, 17, 3};
    }
    ...
    public static long A00(String str, EnumC0758Jp enumC0758Jp) {
        if (A01.containsKey(str)) {
            return A01.get(str).longValue();
        }
        int i = KA.A00[enumC0758Jp.ordinal()];
        if (i != 1) {
            return (i == 2 || i == 3) ? -1000L : -1000L;
        } else if (A04[6].length() != 32) {
            String[] strArr = A04;
    ...
    public static String A03(KC kc) {
        ...
        objArr[1] = kc.A05();
        objArr[2] = kc.A06();
        objArr[3] = Integer.valueOf(kc.A07() == null ? 0 : kc.A07().A00());
        objArr[4] = Integer.valueOf(kc.A07() != null ? kc.A07().A01() : 0);
    ...
    public static boolean A09(KC kc) {
        ...
        if (A00.containsKey(A032)) {
            return System.currentTimeMillis() - A00.get(A032).longValue() < A00(A032, kc.A05());
        }
        return false;
    }
}