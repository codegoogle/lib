...
public final class ea5<T> {
    ...
    private ea5(T t, long j) {
        this.a = t;
        this.b = j;
    }

    public /* synthetic */ ea5(Object obj, long j, DefaultConstructorMarker defaultConstructorMarker) {
        this(obj, j);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ ea5 d(ea5 ea5Var, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
            obj = ea5Var.a;
        }
        if ((i & 2) != 0) {
    ...
    @NotNull
    public final ea5<T> c(T t, long j) {
        return new ea5<>(t, j, null);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof ea5) {
            ea5 ea5Var = (ea5) obj;
            return c25.g(this.a, ea5Var.a) && o95.n(this.b, ea5Var.b);
        }
        return false;
    }
    ...
    public int hashCode() {
        T t = this.a;
        return o95.W(this.b) + ((t == null ? 0 : t.hashCode()) * 31);
    }

    @NotNull
    public String toString() {
        StringBuilder G = wo1.G("TimedValue(value=");
        G.append(this.a);
        G.append(", duration=");
        G.append((Object) o95.L1(this.b));
        G.append(')');
        return G.toString();
    }
}