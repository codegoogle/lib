...
public final class AnonymousClass25 {
    ...
    public static void A01() {
        A03 = new byte[]{106, 120, 66, 73, 67, 29, 17, 30, 17, 23, 21, 47, 17, 20, 47, 0, 2, 21, 22, 21, 2, 21, 30, 19, 21, 3, 60, 35, 39, 58, 60, 61, 32, 12, 32, 54, ax5.a, 54, 48, 39, 54, 55, 52, 51, 38, 53, 51, 100, 98, 116, 99, 78, 123, 126, 100, 99, g15.c, 116, 104, 70, 89, 72, 110, 80, 92, 110, 88, 110, 66, 84, 84, 88, 95, 86, 110, 69, 89, 88, 66};
    }
    ...
    public final void A09(AnonymousClass24 anonymousClass24) {
        ...
        list.add(anonymousClass24.A02() + A00(1, 4, 96));
        JL jl = this.A00;
        if (jl != null) {
            jl.A03(JK.A09, null);
        }
    ...
    public final void A0A(AnonymousClass24 anonymousClass24, int i) {
        List<String> list = this.A02;
        list.add(anonymousClass24.A02() + A00(0, 1, 114) + i);
    }
