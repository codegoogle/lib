...
public class AppCompatImageView extends ImageView implements qr, tt {
    private final AppCompatBackgroundHelper mBackgroundTintHelper;
    private boolean mHasLevel;
    private final AppCompatImageHelper mImageHelper;

    public AppCompatImageView(@x1 Context context) {
        this(context, null);
    }
    ...
    public AppCompatImageView(@x1 Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public AppCompatImageView(@x1 Context context, @z1 AttributeSet attributeSet, int i) {
