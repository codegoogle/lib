...
public final class AnonymousClass59 implements InterstitialAdApi, Repairable {
    ...
    public static void A01() {
        A04 = new byte[]{bx.j7, 20, 21, bx.j7, -25, 17, -29, 17, -71, -74, -74, -25, -66, -72, -66, -71, 35, 32, 40, 37, 82, 31, 34, 81, -49, -12, -6, -21, -8, -12, -25, -14, -90, -21, -8, -8, -11, -8, -76, -112, -29, 8, 14, -1, 12, 13, 14, 3, 14, 3, -5, 6, -70, -5, -2, -70, -2, -1, 13, 14, 12, 9, 19, -1, -2, -56, -19, -13, -28, -15, -14, -13, -24, -13, -24, -32, -21, -97, -32, -29, -97, -21, -18, -32, -29, -97, -15, -28, -16, -12, -28, -14, -13, -28, -29, -18, 19, 25, 10, 23, 24, 25, 14, 25, 14, 6, 17, -59, 6, 9, -59, 24, 13, 20, 28, -59, 8, 6, 17, 17, 10, 9, -10, -9, 5, 6, 4, 1, Flags.CD, -28, -17, -52, -17, bx.j7, -28, -63, -28, 49, 38, 45, 53};
    }
    ...
    public AnonymousClass59(Context context, String str, InterstitialAd interstitialAd) {
        ...
        this.A01 = new C03251s(this.A03, interstitialAd, str);
        this.A03.A0C(this);
        this.A02 = new Ep(this.A01);
    }
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C5A) interstitialLoadAdConfig).A00();
    }
    ...
    public final void repair(Throwable th) {
        if (this.A01.A02() != null) {
            InterstitialAdListener A02 = this.A01.A02();
            InterstitialAd interstitialAd = this.A00;
            A02.onError(interstitialAd, new AdError(2001, A00(24, 16, 8) + LN.A03(this.A03, th)));
        }
    }
    ...
    public final boolean show() {
        K0.A05(A00(WKSRecord.Service.NETBIOS_NS, 4, 64), A00(95, 27, 39), A00(16, 8, 113));
        this.A03.A0A().A2p();
        boolean A0B = this.A02.A0B(this.A00, new C5B());
