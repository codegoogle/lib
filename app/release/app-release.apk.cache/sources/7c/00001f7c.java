...
public final class zzbo {
    ...
    public static int zza(String str, @z1 String str2) {
        char c;
        zzbn zzc;
        switch (str.hashCode()) {
            case -2123537834:
    ...
    public static int zzb(@z1 String str) {
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static boolean zzf(@z1 String str, @z1 String str2) {
        char c;
        zzbn zzc;
        int zza2;
        if (str == null) {
    ...
    public static boolean zzg(@z1 String str) {
        return "audio".equals(zzi(str));
    }

    public static boolean zzh(@z1 String str) {
        return d.a.a.equals(zzi(str));
    }

    @z1
    private static String zzi(@z1 String str) {
        int indexOf;
