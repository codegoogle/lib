...
public class SignInClientImpl extends GmsClient<zaf> implements com.google.android.gms.signin.zae {
    ...
    public SignInClientImpl(@x1 Context context, @x1 Looper looper, boolean z, @x1 ClientSettings clientSettings, @x1 Bundle bundle, @x1 GoogleApiClient.ConnectionCallbacks connectionCallbacks, @x1 GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    @x1
    @KeepForSdk
    public static Bundle createBundleFromClientSettings(@x1 ClientSettings clientSettings) {
        clientSettings.zaa();
    ...
    @x1
    public final /* synthetic */ IInterface createServiceInterface(@x1 IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
    ...
    @Override // com.google.android.gms.signin.zae
    public final void zac(@x1 IAccountAccessor iAccountAccessor, boolean z) {
        try {
