...
public final class SupportFragmentWrapper extends IFragmentWrapper.Stub {
    ...
    @KeepForSdk
    @z1
    public static SupportFragmentWrapper wrap(@z1 Fragment fragment) {
        if (fragment != null) {
    ...
    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void zzk(@x1 IObjectWrapper iObjectWrapper) {
    ...
    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void zzp(@x1 Intent intent) {
        this.zza.startActivity(intent);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void zzq(@x1 Intent intent, int i) {
        this.zza.startActivityForResult(intent, i);
    }

    @Override // com.google.android.gms.dynamic.IFragmentWrapper
    public final void zzr(@x1 IObjectWrapper iObjectWrapper) {
        View view = (View) ObjectWrapper.unwrap(iObjectWrapper);
        Fragment fragment = this.zza;
        Preconditions.checkNotNull(view);
