...
public class AnythinkBTWebView extends BTBaseView implements IMraidJSBridge {
            ...
            public final void a(Object obj) {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(i)) {
                        ...
                        n.a(a.a, "getEndScreenInfo success");
                    } else {
                        n.a(a.a, "getEndScreenInfo failed");
                    }
                    com.anythink.expressad.atsignalcommon.windvane.j.a().a(obj, str);
                } catch (Throwable th) {
                    n.a(a.a, th.getMessage());
                }
            }
    ...
    public void open(String str) {
        try {
            ...
            n.d(BTBaseView.TAG, th.getMessage());
        }
    }
    ...
    public void preload() {
        if (!TextUtils.isEmpty(this.p)) {
            ...
            this.z.loadDataWithBaseURL("", this.r, tm4.D, "UTF-8", null);
        }
    }
