...
public class h90 implements j90 {
    ...
    public static class a extends ViewGroup {
        ...
        public a(Context context, ViewGroup viewGroup, View view, h90 h90Var) {
            super(context);
            this.v = null;
            this.t = viewGroup;
            this.u = view;
        ...
        public ViewParent f(int i, int i2, Rect rect) {
            if (!(this.t instanceof ViewGroup) || s == null) {
                return null;
            }
            try {
                e(new int[2]);
    ...
    public h90(Context context, ViewGroup viewGroup, View view) {
        this.a = new a(context, viewGroup, view, this);
    }

    public static h90 e(View view) {
        ViewGroup f = f(view);
        if (f != null) {
            ...
            return new c90(f.getContext(), f, view);
        }
        return null;
    }
