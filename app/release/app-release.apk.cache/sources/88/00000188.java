...
public class ShareActionProvider extends gq {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(x2.b.A, typedValue, true);
        activityChooserView.setExpandActivityOverflowButtonDrawable(r3.b(this.mContext, typedValue.resourceId));
        activityChooserView.setProvider(this);
        activityChooserView.setDefaultActionButtonContentDescription(x2.k.z);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(x2.k.y);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (min < activityCount) {
            SubMenu addSubMenu = subMenu.addSubMenu(0, min, min, this.mContext.getString(x2.k.e));
