...
public enum b85 {
    ...
    @NotNull
    private static final qo4<Map<Integer, b85>> t = so4.c(a.t);
    private final int P;

    /* compiled from: CharDirectionality.kt */
    @vo4(d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010$\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "", "", "Lkotlin/text/CharDirectionality;", "invoke"}, k = 3, mv = {1, 7, 1}, xi = 48)
    /* loaded from: classes3.dex */
    public static final class a extends e25 implements uz4<Map<Integer, ? extends b85>> {
        ...
        @NotNull
        /* renamed from: h */
        public final Map<Integer, b85> x() {
            b85[] values = b85.values();
            LinkedHashMap linkedHashMap = new LinkedHashMap(i55.n(mt4.j(20), 16));
            for (int i = 0; i < 20; i++) {
                b85 b85Var = values[i];
                linkedHashMap.put(Integer.valueOf(b85Var.h()), b85Var);
            }
    ...
    public static final class b {
        ...
        private final Map<Integer, b85> a() {
            return (Map) b85.t.getValue();
        }

        @NotNull
        public final b85 b(int i) {
            b85 b85Var = a().get(Integer.valueOf(i));
            if (b85Var != null) {
                return b85Var;
            }
            throw new IllegalArgumentException(wo1.n("Directionality #", i, " is not defined."));
        }
    }
