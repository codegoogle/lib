...
public final class hi {
    ...
    public static int a(float f) {
        ...
        float[] fArr = c;
        return fj.g(f5 * fArr[0], f3 * fArr[1], f4 * fArr[2]);
    }
    ...
    public static float[] f(int i) {
        ...
        float[][] fArr = d;
        return new float[]{(fArr[0][2] * e3) + (fArr[0][1] * e2) + (fArr[0][0] * e), (fArr[1][2] * e3) + (fArr[1][1] * e2) + (fArr[1][0] * e), (e3 * fArr[2][2]) + (e2 * fArr[2][1]) + (e * fArr[2][0])};
    }
    ...
    public static float g(int i) {
        ...
        float e3 = e(Color.blue(i));
        float[][] fArr = d;
        return (e3 * fArr[1][2]) + (e2 * fArr[1][1]) + (e * fArr[1][0]);
    }
