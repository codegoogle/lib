...
import com.p7700g.p99005.it;
import com.p7700g.p99005.u3;
...
public class DropDownListView extends ListView {
    ...
    /* loaded from: classes.dex */
    public static class GateKeeperDrawable extends u3 {
    ...
    public DropDownListView(@x1 Context context, boolean z) {
        super(context, null, x2.b.p1);
    ...
    private void positionSelectorLikeFocusCompat(int i, View view) {
        ...
        if (z) {
            ...
            fk.k(selector, exactCenterX, exactCenterY);
        }
    }
        ...
        if (findPointerIndex >= 0) {
            ...
            if (z) {
                if (this.mScrollHelper == null) {
                    this.mScrollHelper = new it(this);
                }
                this.mScrollHelper.o(true);
                this.mScrollHelper.onTouch(this, motionEvent);
            } else {
                it itVar = this.mScrollHelper;
                if (itVar != null) {
                    itVar.o(false);
                }
            }
