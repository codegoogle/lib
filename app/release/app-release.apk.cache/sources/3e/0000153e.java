...
public final class C1119Xu implements B3 {
    ...
    public final float A01(float f) {
        float A00 = C0726Ig.A00(f, 0.1f, 8.0f);
        if (this.A00 != A00) {
            this.A00 = A00;
            this.A08 = null;
        }
    ...
    public final long A03(long j) {
        ...
        if (j2 >= 1024) {
            ...
            int i2 = this.A05;
            if (i == i2) {
                return C0726Ig.A0F(j, this.A06, j2);
            }
            return C0726Ig.A0F(j, this.A06 * i, j2 * i2);
        }
