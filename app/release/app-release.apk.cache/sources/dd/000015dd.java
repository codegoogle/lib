...
public final class C1206aX implements HM {
    ...
    public static void A01() {
        A03 = new byte[]{121, -32, 7, 6, 24, 10, -37, bx.l7, -2, 43, 43, 40, 43, bx.l7, 48, 33, 34, 37, 30, bx.l7, 41, 26, 43, 44, 34, 39, 32, bx.l7, -5, 26, 44, 30, -17, -19, bx.l7, 30, 39, 28, 40, 29, 30, 29, bx.l7, 44, 45, 43, 34, 39, 32, -13, bx.l7, -24, -26, -64, -44, -26, -42, -36, -36, -91, -66, -75, -56, -64, -75, -77, -60, -75, -76, 112, -91, -94, -103, 112, -74, -65, -62, -67, -79, -60, -118, 112, -13, 12, 17, 19, 14, 14, 13, 16, 18, 3, 2, -66, 17, 1, 6, 3, Flags.CD, 3, -40, -66, -35, -38, -19, -38};
    }
    ...
    public final long ABP(HQ hq) throws IOException {
        ...
        if (A00(102, 4, 62).equals(scheme)) {
            String[] A0m = C0726Ig.A0m(uri.getSchemeSpecificPart(), A00(0, 1, 18));
            if (A0m.length == 2) {
