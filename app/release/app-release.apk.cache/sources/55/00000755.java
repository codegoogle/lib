...
public class NativeAdvancedExpandDialog extends Dialog {
    ...
    public class AnonymousClass2 extends b {
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            webView.evaluateJavascript("javascript:" + com.anythink.expressad.d.b.a.a().b(), new ValueCallback<String>() { // from class: com.anythink.expressad.advanced.js.NativeAdvancedExpandDialog.2.1
    ...
    public class AnonymousClass3 implements DialogInterface.OnDismissListener {
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            ...
            NativeAdvancedExpandDialog.this.e.loadDataWithBaseURL(null, "", tm4.D, "utf-8", null);
        ...
        this.j = new IMraidJSBridge() { // from class: com.anythink.expressad.advanced.js.NativeAdvancedExpandDialog.4
            ...
            public void open(String str) {
                try {
                    if (NativeAdvancedExpandDialog.this.e != null && System.currentTimeMillis() - NativeAdvancedExpandDialog.this.e.lastTouchTime > com.anythink.expressad.a.b.a.c) {
                        ...
                        if (com.anythink.expressad.a.b.a.a((c) NativeAdvancedExpandDialog.this.h.get(0))) {
                            return;
                        }
                    }
                    n.d("NativeAdvancedExpandDialog", str);
                    ...
                    n.b("NativeAdvancedExpandDialog", "open", th);
                }
            }
            ...
            public void useCustomClose(boolean z) {
                try {
                    ...
                    n.b("NativeAdvancedExpandDialog", "useCustomClose", th);
                }
            }
        };
        if (bundle != null) {
    ...
    private void b() {
        try {
            ...
            n.b("NativeAdvancedExpandDialog", "notifyMraid", th);
        }
    }
    ...
    public static /* synthetic */ void a(NativeAdvancedExpandDialog nativeAdvancedExpandDialog) {
        try {
            ...
            CallMraidJS callMraidJS = CallMraidJS.getInstance();
            WindVaneWebView windVaneWebView = nativeAdvancedExpandDialog.e;
            callMraidJS.fireSetDefaultPosition(windVaneWebView, iArr[0], iArr[1], windVaneWebView.getWidth(), nativeAdvancedExpandDialog.e.getHeight());
            CallMraidJS callMraidJS2 = CallMraidJS.getInstance();
            WindVaneWebView windVaneWebView2 = nativeAdvancedExpandDialog.e;
            callMraidJS2.fireSetCurrentPosition(windVaneWebView2, iArr[0], iArr[1], windVaneWebView2.getWidth(), nativeAdvancedExpandDialog.e.getHeight());
            CallMraidJS.getInstance().fireSetScreenSize(nativeAdvancedExpandDialog.e, j.e(m.a().e()), j.f(m.a().e()));
