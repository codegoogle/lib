...
public final class ev4 {
    @dx4
    private static final <T> T a(ReentrantReadWriteLock reentrantReadWriteLock, uz4<? extends T> uz4Var) {
        c25.p(reentrantReadWriteLock, "<this>");
        c25.p(uz4Var, "action");
    ...
    @dx4
    private static final <T> T b(Lock lock, uz4<? extends T> uz4Var) {
        c25.p(lock, "<this>");
        c25.p(uz4Var, "action");
        lock.lock();
        try {
    ...
    @dx4
    private static final <T> T c(ReentrantReadWriteLock reentrantReadWriteLock, uz4<? extends T> uz4Var) {
        c25.p(reentrantReadWriteLock, "<this>");
        c25.p(uz4Var, "action");
        ReentrantReadWriteLock.ReadLock readLock = reentrantReadWriteLock.readLock();
        int i = 0;
