...
public class K7 implements LO<Bundle> {
    ...
    public final JE A07;
    public final InterfaceC0880Om A08;
    public final C0885Or A09;
    ...
    public static void A0O() {
        A0C = new byte[]{Flags.CD, 13, 30, 19, 25, 24, -82, -79, -98, -62, -82, -71, -74, -63, -58, -102, -82, -69, -82, -76, -78, -65, -18, 1, -10, -6, -14, -20, -6, 0, -96, -77, -86, -85, -89, -100, -76, -96, -83, -56, -67, -49, -48, -98, -53, -47, -54, -64, -67, -50, -43, -80, -59, -55, -63, -87, -81, -98, -109, -91, -90, -126, -92, -95, -103, -92, -105, -91, -91, -122, -101, -97, -105, g15.c, -123, -21, bx.j7, -33, -14, -35, -21, -15, -23, -33, -14, -16, -37, -23, -17, 20, 12, -33, -37, -45, -43, -56, -45, 26, 30, 13, 17, 6, 10, 2, 27, 34, -87, -98, -94, -102, 37, 27, 16, -16, -26, -25, 19, 9, 10, -2, 21, -64, -70, -78, 10, 4, Flags.CD, 5, 3, -8, -4, -12, -18, -4, 2, -64, -63, -87, -82, 0, 1, -23, -4, -3, -8, -9, -8, -30, 5, 6, -4, -74, -73, -83, -95, -72, -21, -35, -30, -40, -29, -21};
    }
    ...
    public K7(C1080Wh c1080Wh, JE je, InterfaceC0880Om interfaceC0880Om, List<AnonymousClass20> list, String str, boolean z) {
        this(c1080Wh, je, interfaceC0880Om, list, str, z, null);
    }

    public K7(C1080Wh c1080Wh, JE je, InterfaceC0880Om interfaceC0880Om, List<AnonymousClass20> list, String str, boolean z, @Nullable Bundle bundle) {
        this(c1080Wh, je, interfaceC0880Om, list, str, z, bundle, null);
    }

    public K7(C1080Wh c1080Wh, JE je, InterfaceC0880Om interfaceC0880Om, List<AnonymousClass20> list, String str, boolean z, @Nullable Bundle bundle, @Nullable Map<String, String> map) {
        this.A01 = 0;
        this.A00 = 0;
        this.A02 = null;
        this.A03 = null;
        ...
        if (bundle != null) {
            this.A05 = new S6(interfaceC0880Om.getView(), list, bundle.getBundle(A0G(6, 16, 29)), c1080Wh);
            this.A01 = bundle.getInt(A0G(57, 18, 2));
            this.A00 = bundle.getInt(A0G(39, 18, 44));
        } else {
            this.A05 = new S6(interfaceC0880Om.getView(), list, c1080Wh);
        }
        this.A09 = new C0885Or(new Handler(), this);
    }

    private final float A0E() {
        return C0791La.A00(this.A06) * this.A08.getVolume();
    }

    private Map<String, String> A0I(int i) {
        HashMap<String, String> hashMap = new HashMap<>();
        C0791La.A04(hashMap, this.A08.getVideoStartReason() == EnumC0886Os.A03, !this.A08.A7d());
        A0S(hashMap);
        A0R(hashMap);
        A0U(hashMap, i);
        A0T(hashMap);
    ...
    public Map<String, String> A0J(EnumC0881On enumC0881On) {
        return A0K(enumC0881On, this.A08.getCurrentPositionInMillis());
    }

    private Map<String, String> A0K(EnumC0881On enumC0881On, int i) {
        Map<String, String> A0I = A0I(i);
        A0I.put(A0G(0, 6, 122), String.valueOf(enumC0881On.A00));
        return A0I;
    }

    private void A0M() {
        this.A07.A8P(this.A0A, A0J(EnumC0881On.A04));
    }

    private void A0N() {
        this.A07.A8P(this.A0A, A0J(EnumC0881On.A0A));
    }
    ...
    private void A0R(Map<String, String> map) {
        AnonymousClass22 A03 = this.A05.A03();
        AnonymousClass21 A00 = A03.A00();
        map.put(A0G(145, 3, 81), String.valueOf(A00.A00()));
        ...
        String str = this.A02;
        if (str != null) {
            map.put(A0G(WKSRecord.Service.LOC_SRV, 4, 26), str);
        }
        String str2 = this.A03;
        if (str2 != null) {
            map.put(A0G(WKSRecord.Service.NETBIOS_SSN, 6, 90), str2);
        }
        AnonymousClass21 A01 = A03.A01();
    ...
    public final void A0X() {
        this.A05.A04();
        this.A07.A8P(this.A0A, A0J(EnumC0881On.A05));
    }

    public final void A0Y() {
        this.A07.A8P(this.A0A, A0J(EnumC0881On.A07));
    }

    public final void A0Z() {
        this.A07.A8P(this.A0A, A0J(EnumC0881On.A08));
    }
    ...
    public final void A0g(int i, boolean z, boolean z2) {
        ...
        if (i > i2) {
            ...
            if (z2 || i - this.A00 >= 5000) {
                JE je = this.A07;
                String str = this.A0A;
                Map<String, String> A0K = A0K(EnumC0881On.A09, i);
                if (A0D[5].length() == 0) {
                    throw new RuntimeException();
                }
                String[] strArr = A0D;
        ...
        if (z) {
            this.A07.A8P(this.A0A, A0K(EnumC0881On.A09, i));
        }
    }
}