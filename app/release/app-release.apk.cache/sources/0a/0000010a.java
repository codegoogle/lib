...
public class AppCompatRadioButton extends RadioButton implements rt, qr, EmojiCompatConfigurationView, st {
    ...
    @Override // com.p7700g.p99005.rt
    @i2({i2.a.LIBRARY_GROUP_PREFIX})
    public void setSupportButtonTintList(@z1 ColorStateList colorStateList) {
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.mCompoundButtonHelper;
        if (appCompatCompoundButtonHelper != null) {
    ...
    public AppCompatRadioButton(Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, x2.b.H2);
    }

    public AppCompatRadioButton(Context context, @z1 AttributeSet attributeSet, int i) {
    ...
    @Override // android.widget.CompoundButton
    public void setButtonDrawable(@f1 int i) {
