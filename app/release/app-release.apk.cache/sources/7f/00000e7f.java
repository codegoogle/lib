...
public final class C5C implements MediaViewVideoRendererApi {
    ...
    @Nullable
    public NativeAd A08;
    public final JH A0D = new C0607Dl(this);
    public final AbstractC0754Jk A0C = new C0605Dj(this);
    public final AbstractC0766Jy A0B = new C0596Da(this);
    ...
    public static void A02() {
        A0G = new byte[]{-30, 7, 15, -6, 5, 2, -3, -71, -17, 2, -2, 16, -71, -4, 8, 7, 12, 13, Flags.CD, 14, -4, 13, 8, Flags.CD, -71, 9, -6, Flags.CD, -6, 6, 12, -71, 13, 18, 9, -2, -57, -34, -16, -16, -10, -12, -7, -14, -85, -8, 0, -2, -1, -85, -19, -16, -85, -5, -3, -16, -18, -16, -17, -16, -17, -85, -19, 4, -85, -20, -85, -18, -20, -9, -9, -85, -1, -6, -85, -16, -7, -14, -20, -14, -16, -34, -16, -16, -10, -73, -85, -20, -7, -17, -85, -15, -6, -9, -9, -6, 2, -16, -17, -85, -19, 4, -85, -20, -85, -18, -20, -9, -9, -85, -1, -6, -85, -17, -12, -2, -16, -7, -14, -20, -14, -16, -34, -16, -16, -10, -71, -27, -22, -12, -26, -17, -24, -30, -24, -26, -44, -26, -26, -20, -95, -28, -30, -19, -19, -26, -27, -95, -8, -22, -11, -23, -16, -10, -11, -95, -26, -17, -24, -30, -24, -26, -44, -26, -26, -20, -81, 74, 83, 76, 70, 76, 74, 56, 74, 74, 80, 5, 72, 70, 81, 81, 74, 73, 5, 92, 78, 89, 77, 84, 90, 89, 5, 73, 78, 88, 74, 83, 76, 70, 76, 74, 56, 74, 74, 80, 19};
    }
    ...
    public final void A04() {
        ...
        if (nativeAd != null) {
            C1267bZ.A0J(nativeAd.getInternalNativeAd()).A1U(false, false);
        }
        this.A08 = null;
        JV jv = this.A04;
        if (jv != null) {
    ...
    public final void A05(NativeAd nativeAd) {
        this.A08 = nativeAd;
        this.A03.A0D(((C1267bZ) nativeAd.getInternalNativeAd()).A0x());
        C5D c5d = (C5D) nativeAd.getNativeAdApi();
        this.A05.setClientToken(C1267bZ.A0J(nativeAd.getInternalNativeAd()).A15());
        this.A05.setVideoMPD(c5d.A02());
        this.A05.setVideoURI(c5d.A03());
        RG adapter = C1267bZ.A0J(nativeAd.getInternalNativeAd()).A0v();
        if (adapter != null) {
        ...
        this.A01 = c5d.getVideoAutoplayBehavior();
        JV jv = this.A04;
        if (jv != null) {
            jv.AD1(nativeAd);
        }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        ...
        this.A06 = false;
        if (this.A07) {
            this.A05.A0Y(EnumC0886Os.A00(videoStartReason), 3);
        }
    ...
    public final void engageSeek() {
        ...
        this.A06 = true;
        this.A07 = EnumC0898Pe.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1080Wh) {
            ...
            A02 = AnonymousClass57.A02(context);
        }
        this.A03 = A02;
        int initializationType = adViewConstructorParams.getInitializationType();
        if (initializationType == 0) {
            this.A05 = new C05219t(A02);
        } else if (initializationType == 1) {
            this.A05 = new C05219t(A02, adViewConstructorParams.getAttributeSet());
        } else if (initializationType == 2) {
            this.A05 = new C05219t(A02, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
        } else if (initializationType == 3) {
            this.A05 = new C05219t(A02, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
        } else {
    ...
    public final void play(VideoStartReason videoStartReason) {
        this.A05.A0Y(EnumC0886Os.A00(videoStartReason), 2);
    }
