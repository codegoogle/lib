...
public class k75 {
    ...
    @tp4(version = "1.3")
    @NotNull
    public static final <T> Iterator<T> a(@on4 @NotNull j05<? super i75<? super T>, ? super uv4<? super yq4>, ? extends Object> j05Var) {
        c25.p(j05Var, "block");
        h75 h75Var = new h75();
        h75Var.l(fw4.c(j05Var, h75Var, h75Var));
        return h75Var;
    }

    @tp4(version = "1.3")
    @NotNull
    public static final <T> g75<T> b(@on4 @NotNull j05<? super i75<? super T>, ? super uv4<? super yq4>, ? extends Object> j05Var) {
        c25.p(j05Var, "block");
        return new a(j05Var);
    }
}