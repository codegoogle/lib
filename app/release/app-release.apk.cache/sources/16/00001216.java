...
public final class C0780Km {
    ...
    public static void A04() {
        A00 = new byte[]{60, 62, 41, 52, 43, 52, 41, 36, 54, 57, 51, 37, 56, 62, 51, 121, 54, 39, 39, 121, 22, 52, 35, 62, 33, 62, 35, 46, 3, ax5.a, 37, 50, 54, 51, ax5.a, 48, 58, 44, 49, 55, 58, 112, 55, 48, bx.W5, 59, 48, bx.W5, 112, 61, ax5.a, bx.W5, 59, 57, 49, 44, 39, 112, 18, 31, Flags.CD, 16, 29, 22, 27, 12, 53, 35, 36, 36, 51, 56, 34, 23, 53, 34, ax5.a, 32, ax5.a, 34, 47, 2, 62, 36, 51, 55, 50, 34, 14, 44, 59, 38, 57, 38, 59, 38, bx.W5, 60};
    }
    ...
    public static EnumC0779Kl A00() throws ClassNotFoundException, NoSuchMethodException, NoSuchFieldException, InvocationTargetException, IllegalAccessException {
        ...
        for (Object obj : map.values()) {
            ...
            if (activity.isTaskRoot() && activity.getIntent().getCategories().contains(A03(34, 32, 84))) {
                return EnumC0779Kl.A06;
            }
        }
        return EnumC0779Kl.A09;
    }

    public static EnumC0779Kl A01(Context context) {
        try {
            ...
            return EnumC0779Kl.A04;
        }
    }

    @RequiresApi(api = 21)
    public static EnumC0779Kl A02(Context context) {
        if (context == null) {
            return EnumC0779Kl.A0C;
        }
        ActivityManager activityManager = (ActivityManager) context.getSystemService(A03(0, 8, 87));
        if (activityManager == null) {
            return EnumC0779Kl.A07;
        }
        List<ActivityManager.AppTask> appTasks = activityManager.getAppTasks();
        if (appTasks.isEmpty()) {
            return EnumC0779Kl.A0A;
        }
        for (ActivityManager.AppTask appTask : appTasks) {
            ...
            if (taskInfo != null && taskInfo.baseIntent != null) {
                ...
                if (categories != null && taskInfo.baseIntent.getCategories().contains(A03(34, 32, 84))) {
                    return EnumC0779Kl.A05;
                }
            }
        }
        return EnumC0779Kl.A08;
    }
}