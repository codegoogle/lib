...
public final class C03000t {
    ...
    public static void A01() {
        A03 = new byte[]{13, Flags.CD, 56, 58, 43, 74, 65, 76, 93, 86, 95, 91, 74, 75, 112, 70, 75, 84, 88, 88, 78, 73, 73, 94, 85, 88, 94, 72, 111, 122, 109, 118, 112, 123, 27, 12, 22, 23, 60, 12, 0, 0, 22, 17, 17, 6, 13, 0, 6, 60, 16, 6, 0, 16, 22, 1, 27, 26, 49, 30, Flags.CD, 28, 7, 1, 10};
    }
    ...
    public final void A0A(JSONObject jSONObject) throws JSONException {
        ...
        C1K c1k = new C1K(optString);
        if (optString != null && this.A01.has(optString) && (this.A01.get(optString) instanceof C1K)) {
            c1k = (C1K) this.A01.get(optString);
        }
        String A00 = A00(17, 11, 116);
        if (jSONObject.has(A00)) {
            c1k.A06((JSONArray) jSONObject.get(A00));
        }
        String A002 = A00(34, 20, 44);
        if (jSONObject.has(A002)) {
            c1k.A04(jSONObject.optInt(A002));
        }
        c1k.A05(optInt, optInt2, optLong);
        this.A01.put(optString, c1k);
        String[] strArr = A04;
