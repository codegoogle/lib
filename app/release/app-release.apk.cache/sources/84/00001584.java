...
public final class Z2 implements DQ {
    ...
    public static void A01() {
        A06 = new byte[]{25, 62, 72, 56, 54, 71, 57, 62, 67, 60, -11, 62, 67, 75, 54, 65, 62, 57, -11, 30, 25, 8, -11, 73, 54, 60, -16, Flags.CD, -38, -7, 12, 8, Flags.CD, 12, 25, 89, 104, 104, 100, 97, 91, 89, 108, 97, 103, 102, 39, 97, 92, 43};
    }
    ...
    public final void A48(IQ iq) {
        ...
        int min2 = Math.min(A05, this.A01 - this.A00);
    ...
    public final void A4U(CM cm, C0600De c0600De) {
        c0600De.A06();
        this.A03 = cm.ADY(c0600De.A04(), 4);
        this.A03.A5A(Format.A0B(c0600De.A05(), A00(35, 15, 125), null, -1, null));
    }
