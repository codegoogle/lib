...
public final class C5H implements NativeAdsManagerApi {
    ...
    public C5H(Context context, String str, int i) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC0760Js enumC0760Js = EnumC0760Js.A06;
        int i = this.A06;
        C0956Rk c0956Rk = this.A02;
        this.A02 = new C0956Rk(this.A07, this.A08, enumC0760Js, null, i);
        if (this.A05) {
            this.A02.A07();
        }
