...
public final class Target {
    ...
    public static final class Builder {
        ...
        @x1
        public Builder setLightnessWeight(@g1(from = 0.0d) float f) {
            this.mTarget.mWeights[1] = f;
            return this;
        }

        @x1
        public Builder setMaximumLightness(@g1(from = 0.0d, to = 1.0d) float f) {
            this.mTarget.mLightnessTargets[2] = f;
            return this;
        }

        @x1
        public Builder setMaximumSaturation(@g1(from = 0.0d, to = 1.0d) float f) {
            this.mTarget.mSaturationTargets[2] = f;
            return this;
        }

        @x1
        public Builder setMinimumLightness(@g1(from = 0.0d, to = 1.0d) float f) {
            this.mTarget.mLightnessTargets[0] = f;
            return this;
        }

        @x1
        public Builder setMinimumSaturation(@g1(from = 0.0d, to = 1.0d) float f) {
            this.mTarget.mSaturationTargets[0] = f;
            return this;
        }

        @x1
        public Builder setPopulationWeight(@g1(from = 0.0d) float f) {
            this.mTarget.mWeights[2] = f;
            return this;
        }

        @x1
        public Builder setSaturationWeight(@g1(from = 0.0d) float f) {
            this.mTarget.mWeights[0] = f;
            return this;
        }

        @x1
        public Builder setTargetLightness(@g1(from = 0.0d, to = 1.0d) float f) {
            this.mTarget.mLightnessTargets[1] = f;
            return this;
        }

        @x1
        public Builder setTargetSaturation(@g1(from = 0.0d, to = 1.0d) float f) {
            this.mTarget.mSaturationTargets[1] = f;
            return this;
        }

        public Builder(@x1 Target target) {
            this.mTarget = new Target(target);
        }
    }

    public Target(@x1 Target target) {
        float[] fArr = new float[3];
        this.mSaturationTargets = fArr;
        float[] fArr2 = new float[3];
        this.mLightnessTargets = fArr2;
