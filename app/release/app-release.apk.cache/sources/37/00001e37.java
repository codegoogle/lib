...
public final class zzbbz {
    ...
    public final String zza(ArrayList arrayList, ArrayList arrayList2) {
        ...
        loop0: for (int i = 0; i < arrayList2.size(); i++) {
            String[] split = Normalizer.normalize((CharSequence) arrayList.get(((zzbbn) arrayList2.get(i)).zze()), Normalizer.Form.NFKC).toLowerCase(Locale.US).split("\n");
            if (split.length != 0) {
