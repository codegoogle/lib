...
public final class C03181l {
    ...
    public static AdSettings.IntegrationErrorMode A00(C1080Wh c1080Wh) {
        ...
        if (integrationErrorMode == AdSettings.IntegrationErrorMode.INTEGRATION_ERROR_CRASH_DEBUG_MODE && !A03(c1080Wh)) {
    ...
    public static boolean A03(C1080Wh c1080Wh) {
        return (c1080Wh.getApplicationInfo().flags & 2) != 0;
    }
}