...
public class NativeAdScrollView extends LinearLayout {
    ...
    private NativeAdScrollView(Context context, NativeAdsManager nativeAdsManager, @z1 AdViewProvider adViewProvider, int i, @z1 NativeAdView.Type type, @z1 NativeAdViewAttributes nativeAdViewAttributes, int i2) {
        super(context);
