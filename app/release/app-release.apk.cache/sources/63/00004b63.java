...
public final class ju4 {
    ...
    public static final <T> T[] e(@NotNull T[] tArr, int i) {
        ...
        c25.n(tArr2, "null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.builders.ListBuilderKt.copyOfUninitializedElements>");
        return tArr2;
    }
    ...
    public static final <T> boolean h(T[] tArr, int i, int i2, List<?> list) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            if (!c25.g(tArr[i + i3], list.get(i3))) {
                return false;
            }
        }
        return true;
