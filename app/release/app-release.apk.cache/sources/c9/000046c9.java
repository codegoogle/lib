...
public class hk2 {
    ...
    public class b implements d {
        ...
        @Override // com.p7700g.p99005.hk2.d
        @x1
        public fh2 a(@x1 fh2 fh2Var, @x1 fh2 fh2Var2) {
            return new ch2(hk2.l(fh2Var.a(this.a), fh2Var2.a(this.b), this.c, this.d, this.e));
        }
    }
    ...
    public static void p(x80 x80Var, @z1 s80 s80Var) {
        if (s80Var != null) {
            x80Var.V0(s80Var);
        }
    }

    public static boolean q(s80 s80Var, Context context, @q0 int i) {
        int d2;
        if (i == 0 || s80Var.R() != -1 || (d2 = of2.d(context, i, -1)) == -1) {
            return false;
        }
        s80Var.G0(d2);
        return true;
    ...
    public static boolean r(s80 s80Var, Context context, @q0 int i, TimeInterpolator timeInterpolator) {
        if (i == 0 || s80Var.U() != null) {
            return false;
        }
        s80Var.I0(of2.e(context, i, timeInterpolator));
        return true;
    }

    public static boolean s(s80 s80Var, Context context, @q0 int i) {
        i80 u;
    ...
    public static void t(x80 x80Var, @z1 s80 s80Var) {
        if (s80Var != null) {
            x80Var.i1(s80Var);
        }
    }
    ...
    @z1
    public static i80 u(Context context, @q0 int i) {
        TypedValue typedValue = new TypedValue();
        if (context.getTheme().resolveAttribute(i, typedValue, true)) {
            int i2 = typedValue.type;
            if (i2 != 16) {
                if (i2 == 3) {
                    return new k80(mj.e(String.valueOf(typedValue.string)));
                }
