...
public final class pl5 {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [com.p7700g.p99005.ql5] */
    @NotNull
    public static final <N extends ql5<N>> N b(@NotNull N n) {
        while (true) {
            Object e = n.e();
            if (e == b) {
                return n;
    ...
    private static final <S extends xm5<S>> Object c(S s, long j, j05<? super Long, ? super S, ? extends S> j05Var) {
        while (true) {
            if (s.o() < j || s.g()) {
                Object e = s.e();
                if (e == b) {
                ...
                S s2 = (S) ((ql5) e);
                if (s2 == null) {
                    s2 = j05Var.w3(Long.valueOf(s.o() + 1), s);
                    if (s.m(s2)) {
                        if (s.g()) {
                            s.l();
                        }
