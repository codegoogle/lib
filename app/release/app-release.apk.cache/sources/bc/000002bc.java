...
public class ColumnBtnActivity extends og0 {
    ...
    public class c implements wg3 {
        ...
        @Override // com.p7700g.p99005.wg3
        public void H1() {
            ColumnBtnActivity.this.startActivity(new Intent(ColumnBtnActivity.this, Slider_RecycerViewActivity.class));
        }
    }
    ...
    @Override // com.p7700g.p99005.og0
    public void w0() {
        this.W.add(Integer.valueOf((int) R.drawable.col_1));
        this.W.add(Integer.valueOf((int) R.drawable.col_2));
        this.W.add(Integer.valueOf((int) R.drawable.col_3));
        this.W.add(Integer.valueOf((int) R.drawable.col_4));
        this.W.add(Integer.valueOf((int) R.drawable.col_5));
        this.W.add(Integer.valueOf((int) R.drawable.col_6));
