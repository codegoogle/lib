...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(x2.g.a);
        this.mContextView = findViewById(x2.g.h);
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        sr.H1(this, new ActionBarBackgroundDrawable(this));
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, x2.m.a);
        this.mBackground = obtainStyledAttributes.getDrawable(x2.m.b);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(x2.m.d);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(x2.m.o, -1);
        boolean z = true;
        if (getId() == x2.g.j0) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(x2.m.c);
        }
