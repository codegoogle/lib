...
public class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
    ...
    public WaitingRequestManager(@x1 RequestQueue requestQueue) {
    ...
    public WaitingRequestManager(@x1 CacheDispatcher cacheDispatcher, @x1 BlockingQueue<Request<?>> blockingQueue, ResponseDelivery responseDelivery) {
        this.mWaitingRequests = new HashMap();
