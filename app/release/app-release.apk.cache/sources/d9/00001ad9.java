...
public final class JsonUtils {
    ...
    @KeepForSdk
    public static boolean areJsonValuesEquivalent(@z1 Object obj, @z1 Object obj2) {
    ...
    @KeepForSdk
    @z1
    public static String escapeString(@z1 String str) {
    ...
    @x1
    @KeepForSdk
    public static String unescapeString(@x1 String str) {
        if (TextUtils.isEmpty(str)) {
            return str;
        }
