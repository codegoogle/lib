...
public final class C0F {
    ...
    public static void A02() {
        A00 = new byte[]{53, 124, 102, 53, 123, 122, 97, 53, 113, 124, 103, 112, 118, 97, 122, 103, 108, 52, 7, bx.W5, 49, 38, 32, 55, 44, 49, 58, 99, 102, 48, 99, 32, 34, 45, 100, 55, 99, 33, 38, 99, 32, 49, 38, 34, 55, 38, 39, 110, 89, 89, 68, 89, Flags.CD, 89, 78, 72, 89, 78, 74, 95, 78, Flags.CD, 81, 78, 89, 68, 6, 88, 66, 81, 78, Flags.CD, 77, 66, 71, 78, Flags.CD, 36, 19, 19, 14, 19, 65, 18, 4, 21, 65, 13, 0, 18, 21, 65, 12, 14, 5, 8, 7, 8, 4, 5, 65, 5, 0, 21, 4, 65, 21, 14, 65, 69, 106, 111, 102, 35, 99, 102, 117};
    }
    ...
    public static List<File> A01(File file) {
        ...
        if (listFiles != null) {
            ...
            Collections.sort(asList, new C0E());
            return asList;
        }
        return linkedList;
    }
