...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements qr, EmojiCompatConfigurationView, st {
    ...
    public AppCompatMultiAutoCompleteTextView(@x1 Context context) {
        this(context, null);
    }
    ...
    public AppCompatMultiAutoCompleteTextView(@x1 Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, x2.b.S);
    }

    public AppCompatMultiAutoCompleteTextView(@x1 Context context, @z1 AttributeSet attributeSet, int i) {
