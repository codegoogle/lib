...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(@x1 Context context) {
        this(context, null);
    }
    ...
    @Deprecated
    public void setScopes(@x1 Scope[] scopeArr) {
    ...
    public SignInButton(@x1 Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    @Deprecated
    public void setStyle(int i, int i2, @x1 Scope[] scopeArr) {
        setStyle(i, i2);
    }

    public SignInButton(@x1 Context context, @z1 AttributeSet attributeSet, int i) {
