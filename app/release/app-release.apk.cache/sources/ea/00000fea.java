...
public final class BM {
    ...
    public static void A07() {
        A0Q = new String[]{"2OZtSKqBdCORReWjwkUHUNaFdmP57qD6", "wxnNTeBLYydyQqASc88t", "NZCt4jZqJZROeAh1myX6H7SaBhvHRhTJ", bx.y4, "cvmaUkh2yailCvlRg0", "9zfhSGNjdoCRl8j9ORTvg70vvPJm", "N6Pae7kbdU7K2JDJ7pHsGdlVXSdZHDtL", "MG3JHDBNbYnrrwGYpH7tUB1vkoKXKxdT"};
    }
    ...
    private void A09(long j, long audioTimestampSystemTimeUs) {
        ...
        long A03 = this.A0I.A03();
        long audioTimestampPositionFrames = this.A0I.A02();
        if (Math.abs(A03 - j) > 5000000) {
            this.A0N.AB4(audioTimestampPositionFrames, A03, j, audioTimestampSystemTimeUs);
            this.A0I.A05();
        } else if (Math.abs(A02(audioTimestampPositionFrames) - audioTimestampSystemTimeUs) > 5000000) {
            this.A0N.AAa(audioTimestampPositionFrames, A03, j, audioTimestampSystemTimeUs);
            this.A0I.A05();
        } else {
            this.A0I.A04();
        }
    ...
    public final boolean A0M(long j) {
        ...
        if (z && !this.A0K && playState != 1 && (bk = this.A0N) != null) {
            bk.ABB(this.A00, C05269y.A01(this.A05));
        }
        return true;
    }
}