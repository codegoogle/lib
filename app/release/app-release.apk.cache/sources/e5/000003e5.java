...
public final class NetworkUtility {
    ...
    public static void logSlowRequests(long j, Request<?> request, byte[] bArr, int i) {
        if (VolleyLog.DEBUG || j > m.af) {
            Object[] objArr = new Object[5];
            objArr[0] = request;
            objArr[1] = Long.valueOf(j);
            objArr[2] = bArr != null ? Integer.valueOf(bArr.length) : pg1.d;
    ...
    public static RetryInfo shouldRetryException(Request<?> request, IOException iOException, long j, @z1 HttpResponse httpResponse, @z1 byte[] bArr) throws VolleyError {
        ...
        if (iOException instanceof MalformedURLException) {
            ...
            throw new RuntimeException(G.toString(), iOException);
