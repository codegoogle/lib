...
public class PlayCoreDialogWrapperActivity extends Activity {
    ...
    public final void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 0 && (resultReceiver = this.s) != null) {
            if (i2 == -1) {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            this.s = (ResultReceiver) getIntent().getParcelableExtra("result_receiver");
            try {
        ...
        this.s = (ResultReceiver) bundle.getParcelable("result_receiver");
    }

    @Override // android.app.Activity
    public final void onSaveInstanceState(Bundle bundle) {
        bundle.putParcelable("result_receiver", this.s);
    }
}