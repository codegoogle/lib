...
public class ProviderInstaller {
    ...
    public interface ProviderInstallListener {
        void onProviderInstallFailed(int i, @z1 Intent intent);

        void onProviderInstalled();
    }

    public static void installIfNeeded(@x1 Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        Context context2;
    ...
    public static void installIfNeededAsync(@x1 Context context, @x1 ProviderInstallListener providerInstallListener) {
        Preconditions.checkNotNull(context, "Context must not be null");
