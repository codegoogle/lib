...
public final class df5<T, R> extends le5 {
    @NotNull
    private final no5<R> w;
    @NotNull
    private final j05<T, uv4<? super R>, Object> x;

    /* JADX WARN: Multi-variable type inference failed */
    public df5(@NotNull no5<? super R> no5Var, @NotNull j05<? super T, ? super uv4<? super R>, ? extends Object> j05Var) {
        this.w = no5Var;
        this.x = j05Var;
    }
