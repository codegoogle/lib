...
public final class c implements g {
    ...
    public c(String str, String str2, Context context) {
        ...
        this.h = str2;
        if (this.k == null) {
            com.anythink.expressad.advanced.c.b bVar = new com.anythink.expressad.advanced.c.b(m.a().e(), this.i, this.h);
            this.k = bVar;
            bVar.a(this);
        }
        if (this.p == null) {
    ...
    public void j() {
        if (this.F && this.G && this.H && !x.a(this.o.getAdvancedNativeWebview()) && this.E.getAlpha() >= 0.5f && this.E.getVisibility() == 0) {
    ...
    private void g() {
        ...
        if (cVarArr[0] != null) {
            ...
            this.e = true;
            com.anythink.expressad.advanced.c.c.a(this.o, cVarArr[0], this.i, this.h, this.t, true, new c.a() { // from class: com.anythink.expressad.advanced.d.c.2
