...
public final class LX {
    ...
    public static void A02() {
        byte[] bArr = {-48, -60, -124, 120, -69, -60, -63, -69, -61, -65, -51, -71, -54, -68, -84, -63, -59, -67, -110, 120, -8, -5, -25, 6, 10, 0, Flags.CD, 0, 6, 5, -17, -16, -13, -33, -2, 2, -8, 3, -8, -2, -3, -24, -79, -70, -73, -79, -71, -110, -77, -70, -81, -57, -94, -73, -69, -77, 5, 14, Flags.CD, 5, 13, -6, -4, 5, 2, -4, 4, -14, -88, -79, -82, -88, -80, -86, -87, -101, -82, -86, -68, -103, -90, -84, -69, -60, -70, -86, -65, -61, -69, -16, -7, -17, -29, -94, -85, -95, -106, -97, -88, -85, -100, -98, -91, -94, -90, -92, -91, -79, 10, 20, -28, 13, 10, 4, 12, -24, 22, 2, 19, 5, -26, 15, 2, 3, 13, 6, 5, -37, -63, -20, -37, -34, -29, -17, -19, -46, 20, 3, 6, Flags.CD, 23, 21, -5, -53, -66, -68, -56, -53, -67, -62, -57, -64, 121, -62, -58, -55, -53, -66, -52, -52, -62, -56, -57, -109, 121, -59, -58, -77, -60, -58, -90, -69, -65, -73, -52, -51, -70, -53, -51, -79, 7, 8, -11, 6, 8, -19, 4, -10, -15, 1, -11};
        if (A0J[6].length() == 24) {
    ...
    public final Map<String, String> A05() {
        ...
        if (j2 > 0) {
            ...
            if (j3 > j2) {
                ...
                hashMap.put(A01(yg1.G, 5, 96), String.valueOf(this.A06));
                ...
                hashMap.put(A01(WKSRecord.Service.PROFILE, 7, 117), valueOf);
        ...
        hashMap2.put(A01(yg1.G, 5, 96), String.valueOf(this.A06));
        ...
        hashMap2.put(A01(WKSRecord.Service.PROFILE, 7, 117), valueOf);
    ...
    public final void A07(MotionEvent motionEvent, View view, View view2) {
        ...
        if (action != 0) {
            ...
            this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / C0795Le.A01);
            this.A08 = (int) (((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1]) / C0795Le.A01);
            this.A0F = view2;
            return;
        }
        this.A04 = (int) (iArr[0] / C0795Le.A01);
        this.A05 = (int) (iArr[1] / C0795Le.A01);
        this.A06 = (int) (view.getWidth() / C0795Le.A01);
        this.A03 = (int) (view.getHeight() / C0795Le.A01);
        this.A09 = 1;
        this.A0E = System.currentTimeMillis();
        this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / C0795Le.A01);
        this.A0B = (int) (((((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1]) / C0795Le.A01);
    ...
    public final boolean A0A(Context context) {
        ...
        if (BuildConfigApi.isDebug()) {
            String str = A01(108, 21, 116) + z + A01(2, 18, 43) + A05 + A01(0, 2, 119) + A04;
        }
        return z;
    }
}