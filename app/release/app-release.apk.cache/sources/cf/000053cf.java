...
public class o7 extends Drawable {
    ...
    public o7(ColorStateList colorStateList, float f) {
        this.a = f;
        e(colorStateList);
        this.c = new RectF();
        this.d = new Rect();
    ...
    private void i(Rect rect) {
        ...
        this.d.set(rect);
        if (this.f) {
            float d = p7.d(this.e, this.a, this.g);
            this.d.inset((int) Math.ceil(p7.c(this.e, this.a, this.g)), (int) Math.ceil(d));
            this.c.set(this.d);
        }
    }
    ...
    public void f(@z1 ColorStateList colorStateList) {
        e(colorStateList);
        invalidateSelf();
    }
