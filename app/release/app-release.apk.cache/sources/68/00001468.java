...
public final class US extends C6Z {
    ...
    public static void A02() {
        A01 = new byte[]{-7, 19, 18, 37, 37, 22, 35, bx.W5, 30, 18, 31, 18, 24, 22, 35, bx.W5, -11, -18, -1, -18, -11, 60, 81, 0, -16, -18, -7, -14};
    }
    ...
    public US(Context context, C04325z c04325z) {
    ...
    public final AbstractC04566x A0U(int i) {
        if (Build.VERSION.SDK_INT < 21) {
            return A08(EnumC04526t.A05);
        }
    ...
    public final AbstractC04566x A0V(HashMap<String, Integer> resultMap) {
        if (Build.VERSION.SDK_INT < 21) {
            return A08(EnumC04526t.A05);
        }
        BatteryManager batteryManager = this.A00;
