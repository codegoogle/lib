...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(@x1 Context context) {
        this(context, null);
    }

    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(x2.j.a, this);
            LinearLayout linearLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleLayout = linearLayout;
            this.mTitleView = (TextView) linearLayout.findViewById(x2.g.g);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(x2.g.f);
    ...
    public void initForMode(final b4 b4Var) {
        ...
        View findViewById = this.mClose.findViewById(x2.g.m);
    ...
    @Override // androidx.appcompat.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ yr setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(@x1 Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, x2.b.C);
    }

    public ActionBarContextView(@x1 Context context, @z1 AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, x2.m.J, i, 0);
        sr.H1(this, obtainStyledAttributes.getDrawable(x2.m.K));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(x2.m.P, 0);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(x2.m.O, 0);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(x2.m.N, 0);
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(x2.m.M, x2.j.f);
