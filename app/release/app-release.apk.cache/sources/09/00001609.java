...
public final class C1249bF implements JC {
            ...
            if ((i2 < length || i3 < length2) && i > 0) {
                ...
                if (i2 < length && jSONObject == null) {
                    try {
                        ...
                        strArr2[3] = "iJ";
                        if (isDebug) {
                            Log.e(A04, A00(AudioAttributesCompat.N, 33, 107) + i2, e);
                        }
                        jSONObject = null;
                        d = Double.MAX_VALUE;
                    }
    ...
    public static void A05() {
        A02 = new byte[]{21, 83, 90, 71, 21, 80, 67, 80, 91, 65, 124, 81, 21, 60, 111, 105, g15.c, g15.c, 121, 111, 111, 122, 105, 112, 112, 101, 50, 110, 101, 68, 77, 68, 85, 68, 69, 1, 68, 87, 68, 79, 85, 82, 1, 68, 89, 66, 68, 68, 69, 68, 69, 1, 83, 68, 85, 83, 88, 1, 77, 72, 76, 72, 85, 15, 1, 98, 78, 84, 79, 85, 27, 1, 72, 123, 104, 99, 121, 45, 121, 116, 125, 104, 45, 125, g15.c, 98, 110, 104, 126, 126, 104, 105, 45, 111, 116, 45, 121, 101, 104, 45, 126, 104, g15.c, 123, 104, g15.c, 55, 45, 84, 115, 123, 126, 119, 118, 50, 102, 125, 50, 98, 115, 96, 97, 119, 50, 115, 124, 50, 119, 100, 119, 124, 102, 50, 123, 124, 50, 119, 100, 119, 124, 102, 97, 50, 115, 96, 96, 115, 107, 50, 116, 125, 96, 50, 118, 123, 97, 98, 115, 102, 113, 122, 50, 116, 115, 123, 126, 103, 96, 119, 60, 65, 119, 96, 100, 119, 96, 50, 98, 96, 125, 113, 119, 97, 97, 119, 118, 50, 119, 100, 119, 124, 102, 91, 118, 50, 50, 4, 19, 23, 4, 19, 65, 19, 4, 21, 20, 19, 15, 4, 5, 65, 15, 14, 15, 76, 19, 4, 21, 19, 24, 0, 3, 13, 4, 65, 4, 19, 19, 14, 19, 65, 2, 14, 5, 4, 65, bx.W5, 28, Flags.CD, 15, 28, Flags.CD, 89, Flags.CD, 28, 13, 12, Flags.CD, 23, 28, 29, 89, Flags.CD, 28, 13, Flags.CD, 0, 24, 27, 21, 28, 89, 28, Flags.CD, Flags.CD, 22, Flags.CD, 89, 26, 22, 29, 28, 89, 86, 109, 98, 97, 111, 102, 35, 119, 108, 35, 115, 98, 113, 112, 102, 35, 103, 102, 97, 118, 100, 79, 108, 100, 70, 117, 102, 109, 119, 35, 98, 119, 35, 6, 61, 50, 49, ax5.a, 54, 115, 39, 60, 115, 35, 50, 33, 32, 54, 115, 54, 37, 54, 61, 39, 115, 50, 39, 115, 111, 84, 91, 88, 86, 95, 26, 78, 85, 26, 74, 91, 72, 73, 95, 26, 73, 95, 72, 76, 95, 72, 26, 72, 95, 73, 74, 85, 84, 73, 95, 26, 91, 78, 26, 74, 85, 73, 83, 78, 83, 85, 84, 26, 80, 92, 87, 86, 104, 109, 120, 109, 110, 109, g15.c, 105, 17, 2, 17, 26, 0, 7, 6, 5, 1, 20, 21, 18, 5, 77, 3, 15, 14, 6, 9, 7, 77, 5, 22, 5, 14, 20, 77, 13, 1, 7, 9, 3, 33, 34, 38, 51, 50, 53, 34, 24, 36, 40, 41, 33, 46, 32, 44, 33, 71, 90, 94, 86, 60, 39, 35, 45, 38, 59};
    }
    ...
    static {
        A06();
        A05();
        A04 = C1249bF.class.getSimpleName();
    }

    public C1249bF(C1081Wi c1081Wi, XK xk) {
        this.A00 = c1081Wi;
        this.A01 = xk;
    }
    ...
    private JSONObject A03() {
        ...
        if (J9.A0Q(this.A00) && (A032 = C04868k.A03(this.A00)) != null && A032.length() > 0) {
            A5K = A01(A032, A5K);
        }
        JSONObject jSONObject = null;
        if (A5K != null) {
    ...
    private JSONObject A04(int i) {
        ...
        if (J9.A0Q(this.A00) && (A042 = C04868k.A04(this.A00, (A08 = J9.A08(this.A00)))) != null) {
    ...
    public final boolean A7g() {
        int A0F = J9.A0F(this.A00);
        return A0F >= 1 && this.A01.A6D() + C04868k.A00(this.A00) > A0F;
    }
    ...
    public final void A8q() {
        ...
        if (A3z > 0) {
            ...
            int i = C04848i.A0o;
            A042.A82(A00(379, 8, 100), i, new C04858j(A00(28, 44, 73) + A3z));
        }
                ...
                if (A00(393, 26, 8).equals(string)) {
                    ...
                    if (i2 == 1) {
                        ...
                        if (i2 >= 1000 && i2 < 2000) {
                            ...
                            if (BuildConfigApi.isDebug()) {
                                Log.e(A04, A00(yg1.N, 41, 9) + i2 + A00 + string + eventId);
                            }
                            if (!this.A01.A4g(string) && A0Q) {
                                C04868k.A0D(string);
                            }
