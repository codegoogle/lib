...
public final class zzcdp {
    ...
    public static Uri zza(String str, String str2, String str3) {
        ...
        if (indexOf != -1) {
            ...
            wo1.h0(sb, str2, AppCenter.KEY_VALUE_DELIMITER, str3, "&");
    ...
    public static String zzc(String str, Context context, boolean z) {
        String zza;
        if ((!((Boolean) com.google.android.gms.ads.internal.client.zzay.zzc().zzb(zzbhz.zzaj)).booleanValue() || z) && com.google.android.gms.ads.internal.zzt.zzn().zzu(context) && !TextUtils.isEmpty(str) && (zza = com.google.android.gms.ads.internal.zzt.zzn().zza(context)) != null) {
