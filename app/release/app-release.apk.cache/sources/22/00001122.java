...
public final class C0676Gi implements PE {
    ...
    public C0676Gi(View view, int i, boolean z) {
        this.A02 = i;
        this.A03 = view;
        this.A04 = z;
    }
    ...
    private void A05(boolean z) {
        ...
        this.A00 = this.A03.animate().alpha(1.0f).setDuration(this.A02).setListener(new PI(this));
    }

    private void A06(boolean z) {
        this.A01 = PD.A06;
        if (z) {
            this.A00 = this.A03.animate().alpha(0.0f).setDuration(this.A02).setListener(new PJ(this));
            return;
        }
        View view = this.A03;
