...
public class PackageVerificationResult {
    ...
    @x1
    public static PackageVerificationResult zza(@x1 String str, @x1 String str2, @Nullable Throwable th) {
        return new PackageVerificationResult(str, 1, false, str2, th);
    }

    @x1
    public static PackageVerificationResult zzd(@x1 String str, int i) {
