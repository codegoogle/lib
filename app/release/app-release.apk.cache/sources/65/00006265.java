...
import com.p7700g.p99005.wt;

/* compiled from: CursorAdapter.java */
/* loaded from: classes.dex */
public abstract class vt extends BaseAdapter implements Filterable, wt.a {
    @Deprecated
    ...
    public class b extends DataSetObserver {
        ...
        public void onInvalidated() {
            vt vtVar = vt.this;
            vtVar.mDataValid = false;
            vtVar.notifyDataSetInvalidated();
        }
    }
    ...
    @Override // com.p7700g.p99005.wt.a
    ...
    public Filter getFilter() {
        if (this.mCursorFilter == null) {
            this.mCursorFilter = new wt(this);
        }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (this.mDataValid) {
            ...
            throw new IllegalStateException(wo1.l("couldn't move cursor to position ", i));
        }
    ...
    public vt(Context context, Cursor cursor, int i) {
