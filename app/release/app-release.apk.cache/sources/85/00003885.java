...
public enum a85 {
    ...
    /* compiled from: CharCategoryJVM.kt */
    @vo4(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, d2 = {"Lkotlin/text/CharCategory$Companion;", "", "()V", "valueOf", "Lkotlin/text/CharCategory;", f61.b, "", "kotlin-stdlib"}, k = 1, mv = {1, 7, 1}, xi = 48)
    /* loaded from: classes3.dex */
    public static final class a {
        ...
        @NotNull
        public final a85 a(int i) {
            if (new c55(0, 16).o(i)) {
                return a85.values()[i];
            }
            if (new c55(18, 30).o(i)) {
                return a85.values()[i - 1];
            }
            throw new IllegalArgumentException(wo1.n("Category #", i, " is not defined."));
        }
    }

    a85(int i, String str) {
        this.Y = i;
        this.Z = str;
    }

    public final boolean g(char c) {
        return Character.getType(c) == this.Y;
    }
