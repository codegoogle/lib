...
public final class JN {
    ...
    public static List<String> A02(C1080Wh c1080Wh, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                arrayList.add(jSONArray.getString(i));
            } catch (JSONException e) {
                c1080Wh.A04().A82(A00(39, 17, 1), C04848i.A0x, new C04858j(e));
            }
        }
        return arrayList;
    }
    ...
    public static void A05(C1080Wh c1080Wh, String str, long j) {
        JL jl = new JL(str, c1080Wh.A06());
    ...
    public static void A06(C1080Wh c1080Wh, JSONObject jSONObject, long j, @Nullable String str) {
        ...
        if (TextUtils.isEmpty(str) && optJSONArray != null) {
            A07(c1080Wh, optJSONObject, A02(c1080Wh, optJSONArray), j, null);
        } else if (TextUtils.isEmpty(str) || !A02.containsKey(str)) {
        } else {
            A07(c1080Wh, optJSONObject, A02.get(str), j, str);
        }
    }

    public static void A07(C1080Wh c1080Wh, JSONObject jSONObject, List<String> list, long j, @Nullable String str) {
        String A002 = A00(0, 2, 62);
        if (jSONObject.has(A002)) {
            String optString = jSONObject.optString(A002);
            A08(optString, str);
            A09(optString, list);
            A05(c1080Wh, optString, j);
        }
    }
