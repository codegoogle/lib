...
public interface IGmsServiceBroker extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGmsServiceBroker {
        ...
        public final boolean onTransact(int i, @x1 Parcel parcel, @z1 Parcel parcel2, int i2) throws RemoteException {
    ...
    @KeepForSdk
    void getService(@x1 IGmsCallbacks iGmsCallbacks, @z1 GetServiceRequest getServiceRequest) throws RemoteException;
}