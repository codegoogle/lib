...
public final class C5R implements RewardedVideoAdApi, Repairable {
    public static byte[] A04;
    public static String[] A05;
    public final RewardedVideoAd A00;
    public final C03291w A01;
    public final C0634Eo A02;
    ...
    public static void A01() {
        A04 = new byte[]{115, 123, 123, 116, -91, -89, 120, 120, -93, -47, -96, -95, -42, -90, -42, -93, -126, -81, g15.c, g15.c, -126, -81, -125, -127, 74, 73, 122, 69, 122, 121, 76, 77, 62, 62, 108, 110, 109, 111, 109, 106, -80, -76, -84, -84, -81, -34, -33, -80, -109, -65, -65, -110, -106, -61, -66, -111, -90, -45, -89, -44, -96, -44, -92, -88, -113, -76, -70, -85, -72, -76, -89, -78, 102, -85, -72, -72, -75, -72, 116, 80, -110, -91, -73, -95, -78, -92, -91, -92, 96, -74, -87, -92, -91, -81, 96, -95, -92, 96, -92, -91, -77, -76, -78, -81, -71, -91, -92, -76, -57, bx.l7, -61, -44, -58, -57, -58, -126, -40, -53, -58, -57, -47, -126, -61, -58, -126, -50, -47, -61, -58, -126, -44, -57, -45, -41, -57, -43, -42, -57, -58, -72, -53, -35, -57, -40, -54, -53, -54, -122, -36, -49, -54, -53, -43, -122, -57, -54, -122, bx.l7, -50, -43, -35, -122, -55, -57, -46, -46, -53, -54, -116, -115, -101, -100, -102, -105, -95, 112, 115, 101, 104, 69, 104, -42, bx.l7, -53, -50, -85, -50, -80, -36, bx.l7, -41, -84, -45, -50, -97, -108, -101, -93};
    }
    ...
    public C5R(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        this.A00 = rewardedVideoAd;
        this.A03 = AnonymousClass57.A05(context);
        this.A03.A0A().A2j(AdPlacementType.REWARDED_VIDEO.toString());
        this.A01 = new C03291w(this.A03, str, this.A00);
        this.A03.A0C(this);
        this.A02 = new C0634Eo(this.A01);
    }
    ...
    public final void loadAd() {
        K0.A05(A00(HideBottomViewOnScrollBehavior.b, 6, 0), A00(107, 32, 94), A00(48, 8, 89));
        A03(null, true);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C5S) rewardedVideoLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final void loadAd(boolean z) {
        K0.A05(A00(HideBottomViewOnScrollBehavior.b, 6, 0), A00(107, 32, 94), A00(32, 8, 5));
        A03(null, z);
    }
    ...
    public final boolean show() {
        K0.A05(A00(yg1.M, 4, 40), A00(WKSRecord.Service.NETBIOS_SSN, 29, 98), A00(8, 8, 108));
        return show(-1);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final boolean show(int i) {
        K0.A05(A00(yg1.M, 4, 40), A00(WKSRecord.Service.NETBIOS_SSN, 29, 98), A00(40, 8, 119));
        this.A03.A0A().A2p();
        boolean A0C = this.A02.A0C(this.A00, new C5T().withAppOrientation(i).build());
    ...
    public final boolean show(RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        K0.A05(A00(yg1.M, 4, 40), A00(WKSRecord.Service.NETBIOS_SSN, 29, 98), A00(0, 8, 62));
        this.A03.A0A().A2p();
