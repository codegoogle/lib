...
public final class I5 {
    ...
    public static void A05() {
        A00 = new byte[]{5, 62, 35, 37, 32, 32, ax5.a, 34, 36, 53, 52, 112, 49, 37, 52, 57, ax5.a, 112, ax5.a, 50, 58, 53, 51, 36, 112, 36, 41, 32, 53, 106, 112, 116, 79, 82, 84, 81, 81, 78, 83, 85, 68, 69, 1, 68, 81, 98, 78, 79, 71, 72, 70, 27, 1};
    }
    ...
    public static int A01(IP ip) {
        int A05 = ip.A05(4);
        if (A05 == 15) {
            int samplingFrequency = ip.A05(24);
            ...
            strArr[5] = "Rl706moC1hxTN";
            I1.A03(A05 < 13);
            int samplingFrequency2 = A04[A05];
    ...
    public static Pair<Integer, Integer> A02(IP ip, boolean z) throws AN {
        ...
        if (z) {
            ...
            switch (A002) {
                ...
                case 22:
                case 23:
                    int channelCount = ip.A05(2);
                    if (channelCount == 2 || channelCount == 3) {
                        throw new AN(A04(31, 22, 11) + channelCount);
                    }
            }
        }
        int i = A03[A05];
