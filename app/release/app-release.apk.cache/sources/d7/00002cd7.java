...
public final class zzgjy {
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        while (i2 < list.size()) {
            ...
            zzgjxVar2.zzr(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        while (i2 < list.size()) {
            ...
            zzgjxVar2.zzt(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzd(int i, zzgji zzgjiVar) throws IOException {
        this.zza.zzQ(i, zzgjiVar);
    }
    ...
    public final void zzq(int i, Object obj, zzgmt zzgmtVar) throws IOException {
        zzgjx zzgjxVar = this.zza;
        zzgjxVar.zzq(i, 3);
    ...
    public final void zzv(int i, Object obj, zzgmt zzgmtVar) throws IOException {
        this.zza.zzn(i, (zzgma) obj, zzgmtVar);
    }
