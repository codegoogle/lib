...
public final class C0802Ll {
    @TargetApi(18)
    public static Bitmap A00(C1080Wh c1080Wh, Bitmap bitmap, int i) throws RSRuntimeException {
        RenderScript renderScript = null;
        Allocation allocation = null;
        Allocation allocation2 = null;
        ScriptIntrinsicBlur scriptIntrinsicBlur = null;
        try {
            renderScript = RenderScript.create(c1080Wh);
    ...
    @Nullable
    public static Bitmap A01(C1080Wh c1080Wh, Bitmap bitmap, int i, int i2) {
        ...
        try {
            Bitmap A00 = A00(c1080Wh, createBitmap, i);
            if (i2 != 1) {
            ...
            return new C1173a0().A03(createBitmap, i);
        }
    }
}