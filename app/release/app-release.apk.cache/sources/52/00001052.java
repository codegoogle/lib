...
public abstract class DG {
    ...
    private int A00(CL cl) throws IOException, InterruptedException {
        ...
        if (this.A09.A01 != null) {
            ...
            this.A08 = new C1138Yn();
        } else {
            DC A02 = this.A0C.A02();
            this.A08 = new C1132Yh(this.A04, cl.A6T(), this, A02.A01 + A02.A00, A02.A05);
        }
        this.A09 = null;
        this.A01 = 2;
        this.A0C.A05();
    ...
    private int A01(CL cl, CR cr) throws IOException, InterruptedException {
        ...
        if (A0D[1].charAt(31) != 'Q') {
            ...
            if (A08 >= 0) {
                long j = this.A02;
                long granulesInPacket = j + A08;
                if (granulesInPacket >= this.A05) {
                    long A04 = A04(j);
                    this.A07.ACe(A03, A03.A08());
                    this.A07.ACf(A04, 1, A03.A08(), 0, null);
                    this.A05 = -1L;
                }
            }
