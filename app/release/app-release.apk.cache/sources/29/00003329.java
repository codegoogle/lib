...
public final class AdInvalidSignalJsonAdapter extends JsonAdapter<AdInvalidSignal> {
    ...
    @Nullable
    private volatile Constructor<AdInvalidSignal> e;

    public AdInvalidSignalJsonAdapter(@NotNull Moshi moshi) {
        c25.p(moshi, "moshi");
        JsonReader.Options of = JsonReader.Options.of("ts", "session_id", "status", "advid", "campaign_id", "error");
        ...
        this.c = wo1.d(moshi, String.class, "currentSessionId", "moshi.adapter(String::class.java,\n      emptySet(), \"currentSessionId\")");
        this.d = wo1.d(moshi, String.class, "status", "moshi.adapter(String::class.java, emptySet(),\n      \"status\")");
    }
    ...
    public AdInvalidSignal fromJson(@NotNull JsonReader jsonReader) {
            ...
            switch (jsonReader.selectName(this.a)) {
                ...
                case 2:
                    ...
                    if (str2 == null) {
                        ...
                        c25.o(unexpectedNull2, "unexpectedNull(\"status\", \"status\",\n              reader)");
                ...
                case 3:
                    ...
                    if (str3 == null) {
                        ...
                        c25.o(unexpectedNull3, "unexpectedNull(\"advId\", \"advid\",\n              reader)");
        ...
        Constructor<AdInvalidSignal> constructor = this.e;
        if (constructor == null) {
            ...
            this.e = constructor;
            c25.o(constructor, "AdInvalidSignal::class.java.getDeclaredConstructor(Long::class.javaPrimitiveType,\n          String::class.java, String::class.java, String::class.java, String::class.java,\n          String::class.java, Int::class.javaPrimitiveType, Util.DEFAULT_CONSTRUCTOR_MARKER).also {\n          this.constructorRef = it }");
        }
        AdInvalidSignal newInstance = constructor.newInstance(l, str, str2, str3, str4, str5, Integer.valueOf(i), null);
    ...
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable AdInvalidSignal adInvalidSignal) {
        ...
        jsonWriter.name("ts");
        this.b.toJson(jsonWriter, (JsonWriter) Long.valueOf(adInvalidSignal.g()));
        jsonWriter.name("session_id");
        this.c.toJson(jsonWriter, (JsonWriter) adInvalidSignal.d());
        jsonWriter.name("status");
        this.d.toJson(jsonWriter, (JsonWriter) adInvalidSignal.f());
        jsonWriter.name("advid");
        this.d.toJson(jsonWriter, (JsonWriter) adInvalidSignal.b());
        jsonWriter.name("campaign_id");
        this.c.toJson(jsonWriter, (JsonWriter) adInvalidSignal.c());
        jsonWriter.name("error");
        this.c.toJson(jsonWriter, (JsonWriter) adInvalidSignal.e());
        jsonWriter.endObject();
    }

    @NotNull
    public String toString() {
        c25.o("GeneratedJsonAdapter(AdInvalidSignal)", "StringBuilder(capacity).…builderAction).toString()");
