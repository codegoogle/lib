...
public final class yo extends AtomicBoolean implements Runnable {
    @NotNull
    private final uv4<yq4> s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public yo(@NotNull uv4<? super yq4> uv4Var) {
        super(false);
    ...
    public String toString() {
        StringBuilder G = wo1.G("ContinuationRunnable(ran = ");
        G.append(get());
        G.append(')');
        return G.toString();
    }
