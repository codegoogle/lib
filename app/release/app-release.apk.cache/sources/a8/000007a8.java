...
public final class o extends WebChromeClient {
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        if (signalCommunication != null) {
            ...
            com.anythink.expressad.foundation.h.n.a(b, "onConsoleMessage: message.length() = " + message.length() + " " + message);
            if (message.contains("wv_hybrid:") && signalCommunication.a("wv_hybrid:")) {
                String substring = message.substring(0, message.lastIndexOf(" ") + 1);
                com.anythink.expressad.foundation.h.n.a(b, "message = ".concat(String.valueOf(substring)));
    ...
    public final boolean onJsPrompt(WebView webView, String str, String str2, String str3, JsPromptResult jsPromptResult) {
        com.anythink.expressad.foundation.h.n.d(b, String.valueOf(str2));
        d signalCommunication = this.a.getSignalCommunication();
