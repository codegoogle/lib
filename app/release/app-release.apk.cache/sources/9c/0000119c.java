...
public final class C0728Ii {
    ...
    public static void A02() {
        A05 = new byte[]{13, 58, 58, 55, 58, -24, 56, 41, 58, 59, 49, 54, 47, -24, 9, 30, Flags.CD, -24, 43, 55, 54, 46, 49, 47};
    }
    ...
    public C0728Ii(List<byte[]> initializationData, int i, int i2, int i3, float f) {
    ...
    public static C0728Ii A00(IQ iq) throws AN {
        try {
            iq.A0a(4);
            int A0F = (iq.A0F() & 3) + 1;
            if (A0F != 3) {
                ...
                if (width != 27) {
                    ...
                    if (numSequenceParameterSets > 0) {
                        ...
                        IL A062 = IM.A06((byte[]) arrayList.get(0), A0F, height);
                        i = A062.A06;
                        i2 = A062.A02;
                        f = A062.A00;
                    }
                    return new C0728Ii(arrayList, A0F, i, i2, f);
                }
                throw new RuntimeException();
            }
