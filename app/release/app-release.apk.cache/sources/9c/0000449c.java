...
/* compiled from: ToponNativeSmallBottom.java */
/* loaded from: classes3.dex */
public class gh3 implements ATNativeAdRenderer<CustomNativeAd> {
    ...
    public gh3(Activity context, String mdirection) {
        this.d = context;
        this.g = context;
        this.h = mdirection;
    }
    ...
    public View createView(Context context, int i) {
        if (this.e == null) {
            this.e = LayoutInflater.from(context).inflate(zg3.g.z, (ViewGroup) null);
        }
        this.f = i;
