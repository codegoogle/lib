...
public final class C0795Le {
    ...
    public static int A02(int i) {
        if (A0e(i)) {
            return C2G.A02(i, -1, 0.4f);
        }
        return C2G.A02(i, sr.t, 0.2f);
    }
    ...
    public static void A0I(int i, View view) {
        ...
        scaleAnimation.setAnimationListener(new C1176a3(view, scaleAnimation2));
        view.startAnimation(scaleAnimation);
    }
    ...
    public static void A0b(TextView textView, boolean z, int i) {
        ...
        if (!z) {
            ...
            create = Build.VERSION.SDK_INT >= 21 ? Typeface.create(A0F(0, 17, 46), 0) : Typeface.create(Typeface.SANS_SERIF, 1);
        }
