...
public final class AnonymousClass14 extends BroadcastReceiver {
    ...
    public static void A01() {
        A03 = new byte[]{25, 3, 15, 13, 78, 6, 1, 3, 5, 2, 15, 15, Flags.CD, 78, 1, 4, 19, 78, 9, 14, 20, 5, 18, 19, 20, 9, 20, 9, 1, 12, 78, 4, 9, 19, 16, 12, 1, 25, 5, 4, 19, 31, 29, 94, 22, 17, 19, 21, 18, 31, 31, 27, 94, 17, 20, 3, 94, 25, 30, 4, 21, 2, 3, 4, 25, 4, 25, 17, 28, 94, 20, 25, 3, 0, 28, 17, 9, 21, 20, 74, 18, 1, 18, 25, 3, 81, 68, 83, 71, 78, 83, 76, 98, 85, 64, 98, 77, 72, 66, 74, 83, 70, 81, 69, 76, 81, 78, 96, 87, 66, 96, 79, 74, 64, 72, 25, 45, 50, ax5.a, 62, 52, 18, 53, 47, 62, 41, 40, 47, 50, 47, 58, 55, 30, 45, 62, 53, 47, 2, 29, 16, 17, 27, 61, 26, 0, 17, 6, 7, 0, 29, 0, 21, 24, 49, 2, 17, 26, 0, 78};
    }
    ...
    public AnonymousClass14(C05219t c05219t, Context context) {
        this.A01 = c05219t;
        this.A00 = context;
    }
    ...
    public final void A03() {
        ...
        intentFilter.addAction(A00(WKSRecord.Service.NETBIOS_NS, 22, 21) + this.A01.getUniqueId());
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str.equals(A00(116, 21, 58))) {
            ...
            if (serializableExtra instanceof IW) {
                ...
                this.A01.A0Y(EnumC0886Os.A05, 1);
                ...
                strArr2[0] = "WizhEabCQfIhxCPZxjxQrLo8096TZ2te";
                listener.A9d();
            } else if (serializableExtra instanceof C0767Jz) {
                if (this.A01.getListener() == null) {
                    return;
                }
                this.A01.getListener().A9e();
            } else if (serializableExtra instanceof C7v) {
                if (this.A01.getListener() != null) {
                    this.A01.getListener().A9B();
                }
                this.A02 = true;
            } else if (serializableExtra instanceof C0761Jt) {
                if (this.A01.getListener() != null) {
                ...
                this.A02 = false;
            } else if (!(serializableExtra instanceof C04747t) || this.A01.getListener() == null) {
            } else {
