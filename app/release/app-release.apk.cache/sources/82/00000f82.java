...
public final class C05049c {
    ...
    public final synchronized C9T A06(int i, byte[] bArr, int i2, int[] iArr, int i3) throws IOException {
        ...
        if (i >= 0) {
            ...
            if (i5 <= i) {
                return new C9T(z ? C9S.A03 : C9S.A04, i, i, 0);
            }
            A00.A02.seek(j);
            A00.A02.read(bArr, i2, i6);
            return new C9T(C9S.A02, i, i5, i6);
        }
    ...
    public C05049c(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C05039b.A03(file);
        } else if (file.isFile()) {
        } else {
    ...
    private C05039b A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C05039b.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i, long j) throws IOException {
        this.A00.A03[i] = j;
        this.A00.A02.seek(C05039b.A02(i));
