...
public final class C0685Gr {
    ...
    public C0685Gr(String str, int i, String str2, String[] strArr) {
        this.A00 = i;
        this.A01 = str;
        this.A02 = str2;
        this.A03 = strArr;
    ...
    public static C0685Gr A00() {
        String A02 = A02(0, 0, 1);
        return new C0685Gr(A02, 0, A02, new String[0]);
    }

    public static C0685Gr A01(String str, int i) {
        String trim;
        String[] strArr;
        ...
        String[] A0m = C0726Ig.A0m(name, A02(1, 2, 40));
        String str2 = A0m[0];
        if (A0m.length > 1) {
        ...
        return new C0685Gr(str2, i, trim, strArr);
    }
}