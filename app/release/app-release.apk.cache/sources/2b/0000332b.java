...
public final class AdRewardSignalJsonAdapter extends JsonAdapter<AdRewardSignal> {
    ...
    @Nullable
    private volatile Constructor<AdRewardSignal> f;

    public AdRewardSignalJsonAdapter(@NotNull Moshi moshi) {
        c25.p(moshi, "moshi");
    ...
    @NotNull
    /* renamed from: a */
    public AdRewardSignal fromJson(@NotNull JsonReader jsonReader) {
        ...
        Constructor<AdRewardSignal> constructor = this.f;
        if (constructor == null) {
            ...
            this.f = constructor;
            c25.o(constructor, "AdRewardSignal::class.java.getDeclaredConstructor(Long::class.javaPrimitiveType,\n          String::class.java, String::class.java, String::class.java, String::class.java,\n          String::class.java, AdUnitMeasurements::class.java, Int::class.javaPrimitiveType,\n          Util.DEFAULT_CONSTRUCTOR_MARKER).also { this.constructorRef = it }");
        }
        AdRewardSignal newInstance = constructor.newInstance(l, str, str2, str3, str4, str5, adUnitMeasurements, Integer.valueOf(i), null);
    ...
    @Override // com.squareup.moshi.JsonAdapter
    /* renamed from: b */
    public void toJson(@NotNull JsonWriter jsonWriter, @Nullable AdRewardSignal adRewardSignal) {
        c25.p(jsonWriter, "writer");
        Objects.requireNonNull(adRewardSignal, "value_ was null! Wrap in .nullSafe() to write nullable values.");
        jsonWriter.beginObject();
        jsonWriter.name("ts");
        this.b.toJson(jsonWriter, (JsonWriter) Long.valueOf(adRewardSignal.h()));
        jsonWriter.name("session_id");
        this.c.toJson(jsonWriter, (JsonWriter) adRewardSignal.d());
        jsonWriter.name("status");
        this.c.toJson(jsonWriter, (JsonWriter) adRewardSignal.g());
        jsonWriter.name("advid");
        this.c.toJson(jsonWriter, (JsonWriter) adRewardSignal.b());
        jsonWriter.name("campaign_id");
        this.d.toJson(jsonWriter, (JsonWriter) adRewardSignal.c());
        jsonWriter.name("partner");
        this.d.toJson(jsonWriter, (JsonWriter) adRewardSignal.e());
        jsonWriter.name("stat");
        this.e.toJson(jsonWriter, (JsonWriter) adRewardSignal.f());
        jsonWriter.endObject();
    }

    @NotNull
    public String toString() {
        c25.o("GeneratedJsonAdapter(AdRewardSignal)", "StringBuilder(capacity).…builderAction).toString()");
