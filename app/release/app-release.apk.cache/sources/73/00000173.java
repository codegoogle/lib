...
public class SearchView extends LinearLayoutCompat implements c4 {
    ...
    public static class SavedState extends au {
        ...
        public String toString() {
            StringBuilder G = wo1.G("SearchView.SavedState{");
            G.append(Integer.toHexString(System.identityHashCode(this)));
            G.append(" isIconified=");
            G.append(this.isIconified);
            G.append("}");
            return G.toString();
        }
    ...
    public SearchView(@x1 Context context) {
        this(context, null);
    }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(x2.e.c0);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(x2.e.d0);
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        vt vtVar = this.mSuggestionsAdapter;
        if (vtVar != null) {
            vtVar.changeCursor(null);
        }
        if (this.mSearchable.getSuggestAuthority() != null) {
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                i = resources.getDimensionPixelSize(x2.e.Q) + resources.getDimensionPixelSize(x2.e.P);
            } else {
                i = 0;
            }
    ...
    public void onQueryRefine(@z1 CharSequence charSequence) {
    ...
    public void setQueryHint(@z1 CharSequence charSequence) {
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        vt vtVar = this.mSuggestionsAdapter;
        if (vtVar instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) vtVar).setQueryRefinement(z ? 2 : 1);
        }
    }
    ...
    public void setSuggestionsAdapter(vt vtVar) {
        this.mSuggestionsAdapter = vtVar;
        this.mSearchSrcTextView.setAdapter(vtVar);
    }
    ...
    public SearchView(@x1 Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, x2.b.N2);
    }

    public SearchView(@x1 Context context, @z1 AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        ...
        this.mReleaseCursorRunnable = new Runnable() { // from class: androidx.appcompat.widget.SearchView.2
            @Override // java.lang.Runnable
            public void run() {
                vt vtVar = SearchView.this.mSuggestionsAdapter;
                if (vtVar instanceof SuggestionsAdapter) {
                    vtVar.changeCursor(null);
                }
            }
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(x2.m.l5, x2.j.z), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(x2.g.e0);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(x2.g.a0);
        View findViewById = findViewById(x2.g.d0);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(x2.g.o0);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(x2.g.Y);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(x2.g.b0);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(x2.g.Z);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(x2.g.f0);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(x2.g.c0);
        this.mCollapsedIcon = imageView5;
        sr.H1(findViewById, obtainStyledAttributes.getDrawable(x2.m.m5));
        sr.H1(findViewById2, obtainStyledAttributes.getDrawable(x2.m.q5));
        int i2 = x2.m.p5;
        imageView.setImageDrawable(obtainStyledAttributes.getDrawable(i2));
        imageView2.setImageDrawable(obtainStyledAttributes.getDrawable(x2.m.j5));
        imageView3.setImageDrawable(obtainStyledAttributes.getDrawable(x2.m.g5));
        imageView4.setImageDrawable(obtainStyledAttributes.getDrawable(x2.m.s5));
        imageView5.setImageDrawable(obtainStyledAttributes.getDrawable(i2));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(x2.m.o5);
        TooltipCompat.setTooltipText(imageView, getResources().getString(x2.k.v));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(x2.m.r5, x2.j.y);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(x2.m.h5, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(x2.m.k5, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(x2.m.d5, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(x2.m.i5);
        this.mQueryHint = obtainStyledAttributes.getText(x2.m.n5);
        int i3 = obtainStyledAttributes.getInt(x2.m.f5, -1);
        if (i3 != -1) {
            setImeOptions(i3);
        }
        int i4 = obtainStyledAttributes.getInt(x2.m.e5, -1);
        if (i4 != -1) {
            setInputType(i4);
        }
        setFocusable(obtainStyledAttributes.getBoolean(x2.m.c5, true));
