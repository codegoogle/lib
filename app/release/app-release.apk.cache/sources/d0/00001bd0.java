...
public final class zzaff {
    ...
    public final boolean zzb(zzys zzysVar, boolean z) throws IOException {
        zza();
        this.zzg.zzC(27);
        if (zzyv.zzc(zzysVar, this.zzg.zzH(), 0, 27, z) && this.zzg.zzs() == 1332176723) {
            if (this.zzg.zzk() != 0) {
                if (z) {
                    return false;
                }
            ...
            this.zzd = zzk + 27;
            this.zzg.zzC(zzk);
            if (zzyv.zzc(zzysVar, this.zzg.zzH(), 0, this.zzc, z)) {
    ...
    public final boolean zzc(zzys zzysVar, long j) throws IOException {
        ...
        while (true) {
            i = (j > (-1L) ? 1 : (j == (-1L) ? 0 : -1));
            if ((i == 0 || zzysVar.zzf() + 4 < j) && zzyv.zzc(zzysVar, this.zzg.zzH(), 0, 4, true)) {
                this.zzg.zzF(0);
