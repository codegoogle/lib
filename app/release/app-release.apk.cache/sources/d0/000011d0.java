...
public final class C0744Ja implements NativeAdRatingApi {
    ...
    public C0744Ja(double d, double d2) {
        this.A01 = d;
        this.A00 = d2;
    }

    @Nullable
    public static C0744Ja A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        if (A03[1].length() == 15) {
            ...
            strArr[5] = "RjFVMQXNPaplscouVMfMFZlHjMQAuEdy";
            double optDouble = jSONObject.optDouble(A01(5, 5, 78), zg2.s);
            double optDouble2 = jSONObject.optDouble(A01(0, 5, 94), zg2.s);
            if (optDouble != zg2.s) {
                int i = (optDouble2 > zg2.s ? 1 : (optDouble2 == zg2.s ? 0 : -1));
                if (A03[5].charAt(0) == 'R') {
                    String[] strArr2 = A03;
                    strArr2[6] = "dPMTjBEXFaKbbBBBm4MCfcS4F7X28Hbr";
                    strArr2[2] = "0dli5ldtNE7riKXsyOdCpznATSfs344b";
                    if (i != 0) {
                        return new C0744Ja(optDouble, optDouble2);
                    }
                }
            }
            return null;
