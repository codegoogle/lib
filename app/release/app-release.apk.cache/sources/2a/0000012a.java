...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public static final class Api16Impl {
        ...
        @x1
        @e1
        public static StaticLayout createStaticLayoutForMeasuring(@x1 CharSequence charSequence, @x1 Layout.Alignment alignment, int i, @x1 TextView textView, @x1 TextPaint textPaint) {
            return new StaticLayout(charSequence, textPaint, i, alignment, textView.getLineSpacingMultiplier(), textView.getLineSpacingExtra(), textView.getIncludeFontPadding());
        }

        @e1
        public static int getMaxLines(@x1 TextView textView) {
    ...
    public static final class Api18Impl {
        ...
        @e1
        public static boolean isInLayout(@x1 View view) {
    ...
    public static final class Api23Impl {
        ...
        @x1
        @e1
        public static StaticLayout createStaticLayoutForMeasuring(@x1 CharSequence charSequence, @x1 Layout.Alignment alignment, int i, int i2, @x1 TextView textView, @x1 TextPaint textPaint, @x1 Impl impl) {
    ...
    public AppCompatTextViewAutoSizeHelper(@x1 TextView textView) {
    ...
    private static <T> T accessAndReturnWithDefault(@x1 Object obj, @x1 String str, @x1 T t) {
        try {
    ...
    @z1
    private static Field getTextViewField(@x1 String str) {
        try {
    ...
    @z1
    private static Method getTextViewMethod(@x1 String str) {
        try {
    ...
    public static <T> T invokeAndReturnWithDefault(@x1 Object obj, @x1 String str, @x1 T t) {
        try {
    ...
    @x1
    @r2
    public StaticLayout createLayout(@x1 CharSequence charSequence, @x1 Layout.Alignment alignment, int i, int i2) {
    ...
    public void loadFromAttributes(@z1 AttributeSet attributeSet, int i) {
        ...
        sr.y1(textView, textView.getContext(), iArr, attributeSet, obtainStyledAttributes, i, 0);
        int i2 = x2.m.B0;
        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    StringBuilder G = wo1.G("None of the preset sizes is valid: ");
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        if (supportsAutoSizeText()) {
            if (i == 0) {
                ...
                throw new IllegalArgumentException(wo1.l("Unknown auto-size text type: ", i));
            }
        }
    }
