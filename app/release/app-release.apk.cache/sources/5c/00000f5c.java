...
public final class C05018z {
    ...
    public static void A03() {
        A06 = new String[]{"eUnDvYC27elWl0OIYD", "wrMh9NtoanrD8h1augOH3NVqQQ0tAgF4", "3vDVqZB4rWVKvgx5b3OF0nUGahQCrcY0", "6DD0LSomG9znTW4FMaj4ZQ8CLI18bTcT", "m4OyWRD3KmqD5PEshfLk2St9BNh2LjNQ", "DUnTMJffq4UJY2Y02e5xG0xwhTP4jnlH", bx.C4, "fiQ9VXnw7bAvrgjS7V4rUJQz4dMTS6ql"};
    }

    public C05018z(String str, String str2, String str3, Date date) {
        this.A01 = str;
        this.A00 = str2;
        this.A02 = str3;
        this.A03 = date;
    ...
    public C05018z(JSONObject jSONObject) {
    ...
    public static List<C05018z> A01(String str) {
        if (str == null) {
            return null;
        }
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObject != null) {
                arrayList.add(new C05018z(jSONObject));
            }
        }
        return arrayList;
    }
