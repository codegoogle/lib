...
public interface vj5 {
    ...
    public static final class a {
        ...
        @NotNull
        private static final vj5 b = new xj5();
        @NotNull
        private static final vj5 c = new yj5();

        private a() {
        }

        public static /* synthetic */ vj5 b(a aVar, long j, long j2, int i, Object obj) {
            if ((i & 1) != 0) {
                j = 0;
            }
            if ((i & 2) != 0) {
        ...
        @NotNull
        public final vj5 a(long j, long j2) {
            return new zj5(j, j2);
        }
    ...
    @NotNull
    pi5<tj5> a(@NotNull ak5<Integer> ak5Var);
}