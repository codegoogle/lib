...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (view == null || view.getId() != 1) {
                        View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(x2.j.h, viewGroup, false);
                        inflate.setId(1);
                        ((TextView) inflate.findViewById(x2.g.s0)).setText(ActivityChooserView.this.getContext().getString(x2.k.e));
                        return inflate;
                    }
                    return view;
                }
            ...
            if (view == null || view.getId() != x2.g.H) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(x2.j.h, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
            ((ImageView) view.findViewById(x2.g.E)).setImageDrawable(resolveInfo.loadIcon(packageManager));
            ((TextView) view.findViewById(x2.g.s0)).setText(resolveInfo.loadLabel(packageManager));
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            ...
            gq gqVar = ActivityChooserView.this.mProvider;
            if (gqVar != null) {
                gqVar.subUiVisibilityChanged(false);
            }
        }
    ...
    public ActivityChooserView(@x1 Context context) {
        this(context, null);
    }
    ...
    @i2({i2.a.LIBRARY_GROUP_PREFIX})
    public void setProvider(gq gqVar) {
        this.mProvider = gqVar;
    }
    ...
    public void showPopupUnchecked(int i) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            gq gqVar = this.mProvider;
            if (gqVar != null) {
                gqVar.subUiVisibilityChanged(true);
            }
            listPopupWindow.getListView().setContentDescription(getContext().getString(x2.k.f));
    ...
    public ActivityChooserView(@x1 Context context, @z1 AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ActivityChooserView(@x1 Context context, @z1 AttributeSet attributeSet, int i) {
        ...
        sr.y1(this, context, iArr, attributeSet, obtainStyledAttributes, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(x2.m.S, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(x2.m.R);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(x2.j.g, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(x2.g.n);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(x2.g.y);
        ...
        FrameLayout frameLayout2 = (FrameLayout) findViewById(x2.g.A);
        ...
        frameLayout2.setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: androidx.appcompat.widget.ActivityChooserView.3
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                ls.X1(accessibilityNodeInfo).T0(true);
            }
        });
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(x2.e.x));
    }
}