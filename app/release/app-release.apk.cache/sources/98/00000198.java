...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i) {
        int resourceId;
        ColorStateList a;
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (a = r3.a(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i) : a;
    }
    ...
    public Drawable getDrawable(int i) {
        ...
        if (this.mWrapped.hasValue(i) && (resourceId = this.mWrapped.getResourceId(i, 0)) != 0) {
            return r3.b(this.mContext, resourceId);
        }
    ...
    @z1
    public Typeface getFont(@n2 int i, int i2, @z1 oi.g gVar) {
        ...
        return oi.k(this.mContext, resourceId, this.mTypedValue, i2, gVar);
    }
