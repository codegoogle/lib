...
public class WKSRecord extends Record {
            ...
            if (value >= 0) {
                ...
                while (true) {
                    ...
                    if (value2 >= 0) {
                        ...
                        StringBuilder G = wo1.G("Invalid TCP/UDP service: ");
                        G.append(token.value);
                        throw tokenizer.exception(G.toString());
                    }
                }
            } else {
                throw wo1.X("Invalid IP protocol: ", string, tokenizer);
            }
        } else {
    ...
    public WKSRecord(Name name, int i, long j, InetAddress inetAddress, int i2, int[] iArr) {
        ...
        if (Address.familyOf(inetAddress) == 1) {
            ...
            this.protocol = Record.checkU8(xu0.f.m, i2);
            for (int i3 : iArr) {
                Record.checkU16(kg.B0, i3);
            }
