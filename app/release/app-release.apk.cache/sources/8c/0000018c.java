...
public class SuggestionsAdapter extends xt implements View.OnClickListener {
    ...
    public static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(x2.g.z);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(x2.b.x3, typedValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            Drawable i = gh.i(this.mProviderContext, parseInt);
            storeInIconCache(str2, i);
            return i;
        } catch (Resources.NotFoundException unused) {
            return null;
    ...
    @Override // com.p7700g.p99005.vt, android.widget.BaseAdapter, android.widget.SpinnerAdapter
    ...
    @Override // com.p7700g.p99005.vt, android.widget.Adapter
    ...
    @Override // com.p7700g.p99005.vt, android.widget.BaseAdapter, android.widget.Adapter
    public boolean hasStableIds() {
        return false;
    }

    @Override // com.p7700g.p99005.xt, com.p7700g.p99005.vt
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        View newView = super.newView(context, cursor, viewGroup);
        newView.setTag(new ChildViewCache(newView));
        ((ImageView) newView.findViewById(x2.g.z)).setImageResource(this.mCommitIconResId);
        return newView;
    }
