...
public final class C0811Lu implements SensorEventListener {
    ...
    public final Set<InterfaceC0810Lt> A09 = new CopyOnWriteArraySet();
    ...
    public static void A02() {
        A0A = new byte[]{119, 65, 74, 87, 75, 86, 87, 4, 74, 75, 80, 4, 87, 81, 84, 84, 75, 86, 80, 65, 64, 17, bx.W5, 35, 41, 43, 44, 37, 98, 44, 45, 54, 98, 49, 55, 50, 50, 45, 48, 54, 39, 38, 21, 3, 8, 21, 9, 20};
    }

    public C0811Lu(C1080Wh c1080Wh) {
        this.A08 = c1080Wh;
    }
    ...
    public final void A03(InterfaceC0810Lt interfaceC0810Lt) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC0810Lt)) {
            return;
        }
        this.A09.add(interfaceC0810Lt);
    }
            ...
            if (speed > 800.0f) {
                ...
                if (i >= 3) {
                    ...
                    if (elapsedRealtime - now3 > 1000) {
                        ...
                        this.A03 = 0;
                        for (InterfaceC0810Lt interfaceC0810Lt : this.A09) {
                            interfaceC0810Lt.AAv();
                        }
                    }
                }
