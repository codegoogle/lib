...
public final class C05008y {
    ...
    public C05008y(String str, String str2, JSONObject jSONObject, @Nullable JSONArray jSONArray) {
        this.A00 = str;
        this.A01 = str2;
        this.A03 = jSONObject;
        ...
        for (AnonymousClass92 anonymousClass92 : AnonymousClass92.values()) {
            this.A02.put(anonymousClass92, new LinkedList());
        }
    ...
    public final List<String> A05(AnonymousClass92 anonymousClass92) {
        return this.A02.get(anonymousClass92);
    }
