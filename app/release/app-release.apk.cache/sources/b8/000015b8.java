...
public final class DialogC1169Zw extends Dialog implements C8F {
    ...
    static {
        A02();
        A08 = (int) (C0795Le.A01 * 16.0f);
        A07 = Color.parseColor(A00(0, 7, 47));
    }

    public DialogC1169Zw(C1080Wh c1080Wh, Activity activity) {
        super(activity);
        this.A05 = c1080Wh;
        setCancelable(false);
    ...
    private void A01() {
        ...
        this.A04.setTextColor(sr.t);
        this.A04.setPadding(0, 0, 0, A08);
        C0795Le.A0b(this.A04, true, 18);
        ...
        C0795Le.A0W(this.A01, gradientDrawable2);
        C0795Le.A0N(this.A00);
        this.A00.setAllCaps(true);
        this.A00.setGravity(17);
        C0795Le.A0P(this.A00, -1);
