...
public final class C0943Qx implements C0L {
    ...
    public static void A04() {
        A08 = new byte[]{-65, 8, 18, -65, 8, 13, 19, 4, 17, 17, 20, 15, 19, 4, 3, -65, 19, 14, -65, -45, bx.W5, 28, 39, 27, -45, 34, 25, 25, 38, 24, 39, -45, -19, bx.j7, 36, 48, 47, 53, 38, 47, 53, -18, 45, 38, 47, 40, 53, 41, -5, bx.j7, -100, -84, -110, -43, bx.j7, -32, -32, -41, -43, -26, -37, bx.j7, -32, -110, -37, -27, -110, -45, -44, -27, -41, -32, -26, -109, 8, 52, 51, 57, bx.W5, 51, 57, -27, 46, 51, 43, 52, -27, 43, 52, 55, -27, 37, -1, 44, 44, 41, 44, -38, 30, 35, 45, 29, 41, 40, 40, 31, 29, 46, 35, 40, 33, -38, 2, 46, 46, bx.W5, 15, 44, 38, -3, 41, 40, 40, 31, 29, 46, 35, 41, 40, -17, 28, 28, 25, 28, -54, 16, 15, 30, 13, 18, 19, 24, 17, -54, 19, 24, 16, 25, -54, 16, 28, 25, 23, -54, bx.j7, 14, 14, Flags.CD, 14, -68, Flags.CD, 12, 1, 10, 5, 10, 3, -68, -1, Flags.CD, 10, 10, 1, -1, 16, 5, Flags.CD, 10, -68, 2, Flags.CD, 14, -68, 10, 55, 55, 52, 55, -27, 55, bx.W5, 38, 41, 46, 51, 44, -27, 41, 38, 57, 38, -27, 43, 55, 52, 50, -27, -50, -6, -6, -10, -37, -8, -14, bx.l7, -11, -5, -8, -23, -21, 1, -5, -8, -14, -61, -83, -38, -3, -15, -17, 2, -9, -3, -4, 18, 51, 40, 49, -29, 38, 50, 49, 49, 40, 38, 55, 44, 50, 49, -29, -21, -6, 7, 0, -2, -53, -34, -38, -35, -103, -36, -24, -25, -19, -34, -25, -19, -103, -30, -25, -33, -24, -103, -33, -21, -24, -26, -103, 15, 34, 30, 33, 38, 43, 36, -35, 48, 44, 50, 47, 32, 34, -35, 27, 54, 54, -25, 52, 40, 53, 64, -25, 57, 44, 43, 48, 57, 44, bx.W5, 59, 58, 1, -25, -9, -47, -73, 4, 0, 4, -4, -47, -73, 62, 85, 80, 65, 79, 25, 49};
    }
    ...
    static {
        A05();
        A04();
        A07 = C0943Qx.class.getSimpleName();
    }

    public C0943Qx(String str) {
        this(str, C0J.A01(str));
    }

    public C0943Qx(String str, int i) {
        this(str);
        this.A00 = i;
    }

    public C0943Qx(String str, @Nullable String str2) {
    ...
    private HttpURLConnection A02(int i, int i2) throws IOException, C0941Qv {
        String A01;
        ...
        do {
            ...
            if (code > 5) {
                throw new C0941Qv(A01(293, 20, 106) + code);
            }
        } while (z);
        return httpURLConnection;
    }

    private void A03() throws C0941Qv {
    ...
    private final void A06(int i, int i2) throws C0941Qv {
        try {
            this.A02 = A02(i, i2);
            ...
            throw new C0941Qv(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e);
        }
    }
    ...
    public final void close() throws C0941Qv {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C0941Qv(A01(92, 37, 93), e);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.X.C0L
    public final synchronized int length() throws C0941Qv {
        int i;
        int i2 = this.A05;
    ...
    public final int read(byte[] bArr) throws C0941Qv {
        ...
        String A01 = A01(yg1.D, 24, 104);
        if (inputStream != null) {
            try {
                return inputStream.read(bArr, 0, bArr.length);
            } catch (InterruptedIOException e) {
                throw new C0650Fg(A01(a.aS, 15, 96) + this.A03 + A01(0, 15, 66), e);
            } catch (IOException e2) {
                throw new C0941Qv(A01 + this.A03, e2);
            }
        }
        throw new C0941Qv(A01 + this.A03 + A01(51, 23, 21));
    }
