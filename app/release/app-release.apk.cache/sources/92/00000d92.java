...
public final class C1K {
    ...
    public static void A02() {
        A06 = new byte[]{70, 27, 12, 109, 60, 8, 31, Flags.CD, 15, 31, 20, 25, 3, 90, 57, 27, 10, 10, 19, 20, 29, 90, 62, 27, 14, 27, 64, 90, 20, 21, 20, 31, 90, 51, 20, 14, 31, 29, 31, 8, 90, 21, 25, 25, 15, 8, 8, 31, 20, 25, 31, 1, Flags.CD, 9, 24, 53, 62, 51, 34, 41, 32, 36, 53, 52, 15, 57, 52, 55, 59, 59, 45, bx.W5, bx.W5, 61, 54, 59, 61, 43, 119, 98, 117, 110, 104, 99, 57, 46, 52, 53, 30, 46, 34, 34, 52, 51, 51, 36, 47, 34, 36, 30, 50, 36, 34, 50, 102, 113, 107, 106, 65, 110, 123, 108, 119, 113, 122, 34, 27};
    }
    ...
    public final String toString() {
        ...
        String A00 = A00(1, 1, 75);
        sb.append(A00);
        sb.append(this.A04);
        String A002 = A00(0, 1, 0);
        sb.append(A002);
