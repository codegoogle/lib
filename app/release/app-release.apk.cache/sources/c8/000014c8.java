...
public final class W0 extends C6Z {
    @Nullable
    ...
    static {
        A09();
        A08();
        A05 = W0.class.getSimpleName();
    }

    public W0(Context context, C04325z c04325z) {
    ...
    public AbstractC04566x A02(HashMap<String, C1072Vz> hashMap) {
        return new WY(SystemClock.elapsedRealtime(), A01, hashMap, EnumC04556w.A0C);
    }
