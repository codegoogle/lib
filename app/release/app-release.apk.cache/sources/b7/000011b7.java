...
public final class JB {
    ...
    public JB(C8H c8h, String str, double d, String str2, Map<String, String> map, JF jf, JG jg, boolean z) {
        this.A05 = str;
        this.A00 = d;
        this.A04 = str2;
        this.A02 = jf;
        ...
        String A01 = JN.A01(str);
        if (!TextUtils.isEmpty(A01) && (z || jg == JG.A0C)) {
            hashMap.put(A00(6, 21, 61), A01);
        }
        if (A0C()) {
            hashMap.put(A00(0, 6, 63), LD.A01(c8h.A02().A5N()));
        }
