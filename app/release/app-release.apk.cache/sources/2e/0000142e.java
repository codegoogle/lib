...
public final class TW implements AnonymousClass68 {
    ...
    public static void A01() {
        byte[] bArr = {74, 119, 108, 106, g15.c, 123, 102, 96, 97, 47, 109, 122, 102, 99, 107, 102, 97, 104, 47, 73, 78, 65, 47, 99, 96, 104, 104, 102, 97, 104, 47, 69, 92, 64, 65, 122, 81, 70, 81, 30, 24, 35, 24, 29, 8, 29, 35, 16, 19, 27, 27, 21, 18, 27, 96, 107, 102, 5, 66, 74, 22, 0, 7, 38, 55, 92, 1, 10, 12};
        String[] strArr = A02;
    ...
    static {
        A02();
        A01();
        A03 = TW.class.getSimpleName();
    }

    public TW(C1081Wi c1081Wi) {
        this.A00 = c1081Wi;
    }
    ...
    public final void A8B(String str, String str2, Map<String, String> map, @Nullable String str3, @Nullable String str4, @Nullable String str5, @Nullable String str6) {
        ...
        try {
            ...
            C04858j c04858j = new C04858j(jSONObject.toString());
            c04858j.A03(1);
            this.A00.A04().A83(A00(39, 15, 77), 3202, c04858j);
