...
public final class C9E {
    ...
    public static void A02() {
        A00 = new byte[]{3, -1, -2, 50, 33, 38, 34, 43, 32, 34, Flags.CD, 34, 49, 52, 44, 47, 40, -63, -67, -78, -76, -74, -66, -74, -65, -59, -60, -48, -68, -74, -54, -27, -3, -5, 2, 2, -5, 0, -7, -78, -5, 0, -5, 6, -78, -10, 7, -9, -78, 6, 1, -78, -2, -13, -11, -3, -78, 1, -8, -78, -11, 1, 0, 0, -9, -11, 6, -5, 8, -5, 6, Flags.CD, -64, 27, 34, 29, 29, 30, 43, 24, 45, 40, 36, 30, 39, 3, 22, 15, 5, 13, 6, 20, -8, 4, 3, 3, -6, -8, 9, -2, Flags.CD, -2, 9, 14, 38, 50, 49, 55, 40, 59, 55, -50, -51, -55, -36, -35, -38, -51, -57, -53, -41, -42, -50, -47, -49, 6, 9, 12, 12, bx.l7, -54, -30, -43, -40, -54, -51, -46, -50, -61, -59, -57, -49, -57, -48, -42, -63, -56, -47, -44, -49, -61, -42, -43, 27, 23, 12, 14, 16, 24, 16, 25, 31, 10, 20, 15, 30, 16, 3, 15, 19, 3, 17, 18};
    }
    ...
    public static void A04(C1081Wi c1081Wi, MultithreadedBundleWrapper multithreadedBundleWrapper) throws JSONException {
        ArrayList<String> stringArrayList;
        NetworkInfo activeNetworkInfo;
        String bidderToken = DynamicLoaderFactory.makeLoader(c1081Wi).createBidderTokenProviderApi().getBidderToken(c1081Wi);
        ConnectivityManager connectivityManager = (ConnectivityManager) c1081Wi.getSystemService(A01(92, 12, 72));
        ...
        InterfaceC0906Pm A022 = Q4.A02(false, c1081Wi);
        ...
        A05(c1081Wi, jSONObject2);
        JSONObject jSONObject3 = new JSONObject();
        jSONObject3.put(A01(WKSRecord.Service.PROFILE, 17, 21), A01(125, 4, 83));
    ...
    public static void A05(C1081Wi c1081Wi, JSONObject jSONObject) throws JSONException {
        for (Map.Entry<String, String> entry : C9C.A00().A01(c1081Wi, true).A69().entrySet()) {
