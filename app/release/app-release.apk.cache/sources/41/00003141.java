...
public final class zzhf {
    ...
    public static final String[] zzc = {"_aa", "_ac", "_xa", "_aq", "_ar", "_xu", "_ab", "_cd", "_ae", "_ui", "app_store_refund", "app_store_subscription_cancel", "app_store_subscription_convert", "app_store_subscription_renew", "_ug", "_au", rs2.f.l, "_err", "_f", "_v", "_iap", rs2.f.o, rs2.f.p, rs2.f.n, rs2.f.m, "_ou", "_s", "_ssr", "_e", "_ai", "_vs", "_ep", rs2.f.l};
