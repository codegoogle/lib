...
public class ImageRequest extends Request<Bitmap> {
    ...
    public ImageRequest(String str, Response.Listener<Bitmap> listener, int i, int i2, ImageView.ScaleType scaleType, Bitmap.Config config, @z1 Response.ErrorListener errorListener) {
