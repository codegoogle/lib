...
public class h55 {
    ...
    /* JADX WARN: Incorrect types in method signature: <T:Ljava/lang/Object;R::Ljava/lang/Iterable<+TT;>;:Lcom/p7700g/p99005/y45<TT;>;>(TR;TT;)Z */
    @dx4
    @tp4(version = "1.3")
    private static final boolean b(Iterable iterable, Object obj) {
        c25.p(iterable, "<this>");
        return obj != null && ((y45) iterable).a((Comparable) obj);
    }

    @tp4(version = "1.1")
    @NotNull
    public static final x45<Double> c(double d, double d2) {
        return new v45(d, d2);
    }

    @tp4(version = "1.1")
    @NotNull
    public static final x45<Float> d(float f, float f2) {
        return new w45(f, f2);
    }

    @NotNull
    public static final <T extends Comparable<? super T>> y45<T> e(@NotNull T t, @NotNull T t2) {
        c25.p(t, "<this>");
        c25.p(t2, "that");
        return new z45(t, t2);
    }
