...
public class ActionMenuView extends LinearLayoutCompat implements p4.b, x4 {
    ...
    private p4 mMenu;
    public p4.a mMenuBuilderCallback;
    ...
    /* loaded from: classes.dex */
    public static class ActionMenuPresenterCallback implements w4.a {
    ...
    /* loaded from: classes.dex */
    public class MenuBuilderCallback implements p4.a {
        ...
        public void onMenuModeChange(@x1 p4 p4Var) {
            p4.a aVar = ActionMenuView.this.mMenuBuilderCallback;
            if (aVar != null) {
                aVar.onMenuModeChange(p4Var);
            }
        }
    }
    ...
    public ActionMenuView(@x1 Context context) {
        this(context, null);
    }
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i14 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                layoutParams.preventEdgeOffset = z5 && ((ActionMenuItemView) childAt).e();
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu = p4Var;
            p4Var.X(new MenuBuilderCallback());
            ActionMenuPresenter actionMenuPresenter = new ActionMenuPresenter(context);
            this.mPresenter = actionMenuPresenter;
            actionMenuPresenter.setReserveOverflow(true);
            ActionMenuPresenter actionMenuPresenter2 = this.mPresenter;
            w4.a aVar = this.mActionMenuPresenterCallback;
            if (aVar == null) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int size = View.MeasureSpec.getSize(i);
        if (this.mFormatItems && (p4Var = this.mMenu) != null && size != this.mFormatItemsWidth) {
    ...
    public ActionMenuView(@x1 Context context, @z1 AttributeSet attributeSet) {
        super(context, attributeSet);
