...
public class ErrorDialogFragment extends DialogFragment {
    ...
    @x1
    public static ErrorDialogFragment newInstance(@x1 Dialog dialog) {
    ...
    @x1
    public static ErrorDialogFragment newInstance(@x1 Dialog dialog, @z1 DialogInterface.OnCancelListener onCancelListener) {
