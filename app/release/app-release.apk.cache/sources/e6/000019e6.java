...
public class DataBufferSafeParcelable<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    ...
    @KeepForSdk
    public DataBufferSafeParcelable(@x1 DataHolder dataHolder, @x1 Parcelable.Creator<T> creator) {
        super(dataHolder);
        this.zab = creator;
    }

    @KeepForSdk
    public static <T extends SafeParcelable> void addValue(@x1 DataHolder.Builder builder, @x1 T t) {
