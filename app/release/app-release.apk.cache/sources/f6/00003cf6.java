...
public final class ck5 {
    @NotNull
    private static final an5 a = new an5("NONE");
    @NotNull
    private static final an5 b = new an5("PENDING");

    @NotNull
    public static final <T> lj5<T> a(T t) {
        if (t == null) {
            t = (T) bl5.a;
        }
        return new bk5(t);
    ...
    @NotNull
    public static final <T> pi5<T> d(@NotNull ak5<? extends T> ak5Var, @NotNull xv4 xv4Var, int i, @NotNull ng5 ng5Var) {
        boolean z = false;
        if (i >= 0 && i < 2) {
            z = true;
        }
        return ((z || i == -2) && ng5Var == ng5.DROP_OLDEST) ? ak5Var : rj5.e(ak5Var, xv4Var, i, ng5Var);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v0, types: [T, java.lang.Object] */
    public static final <T> T e(@NotNull lj5<T> lj5Var, @NotNull f05<? super T, ? extends T> f05Var) {
        ?? r0;
        do {
            r0 = (Object) lj5Var.getValue();
        } while (!lj5Var.p(r0, f05Var.M(r0)));
        return r0;
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> void h(@NotNull lj5<T> lj5Var, @NotNull f05<? super T, ? extends T> f05Var) {
        Object obj;
        do {
            obj = (Object) lj5Var.getValue();
        } while (!lj5Var.p(obj, f05Var.M(obj)));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <T> T i(@NotNull lj5<T> lj5Var, @NotNull f05<? super T, ? extends T> f05Var) {
        Object obj;
        T M;
        do {
            obj = (Object) lj5Var.getValue();
            M = f05Var.M(obj);
        } while (!lj5Var.p(obj, M));
        return M;
    }
}