...
public final class zav extends AbstractSafeParcelable {
    ...
    public zav(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) @z1 IBinder iBinder, @SafeParcelable.Param(id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(id = 4) boolean z, @SafeParcelable.Param(id = 5) boolean z2) {
        this.zaa = i;
        this.zab = iBinder;
