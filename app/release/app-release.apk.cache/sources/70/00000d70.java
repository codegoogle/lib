...
public final class C02930m {
    ...
    public C02930m(JE je, Activity activity, int i) {
        this.A05 = je;
    ...
    public static C02930m A00(JE je, Activity activity) {
        return A01(je, activity, Build.VERSION.SDK_INT);
    }

    @Nullable
    @VisibleForTesting
    public static C02930m A01(JE je, Activity activity, int i) {
        if (activity != null && i >= 14) {
            return new C02930m(je, activity, i);
        }
        return null;
    }

    private void A05(String str, long j, long j2, @Nullable EnumC02850e enumC02850e) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j));
        hashMap.put(A02(0, 9, 34), Long.toString(j2));
        if (enumC02850e != null) {
            hashMap.put(A02(19, 7, 9), enumC02850e.name());
        }
    ...
    public final void A06() {
        ...
        if (application != null && (c02920l = this.A03) != null) {
            application.unregisterActivityLifecycleCallbacks(c02920l);
            this.A03 = null;
            this.A01 = null;
        }
    }

    public final void A07(@Nullable EnumC02850e enumC02850e) {
        this.A02 = enumC02850e;
    }
    ...
    public final void A08(String str) {
        ...
        EnumC02850e enumC02850e = EnumC02850e.A03;
        if (A07[2].charAt(6) == '9') {
