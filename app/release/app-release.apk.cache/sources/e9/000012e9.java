...
public final class OE {
    ...
    public static JSONObject A01(C1080Wh c1080Wh, JSONObject iconObject, C7H c7h, JL jl, O7 o7) {
        String A002 = A00(101, 3, 106);
        if (!c7h.A0Y(iconObject.optString(A00(51, 26, 80)))) {
            return iconObject;
        }
        jl.A03(JK.A0P, null);
        try {
            ...
            if (optJSONObject != null && optJSONObject.optString(A002) != null) {
                optJSONObject.put(A002, c7h.A0K(optJSONObject.optString(A002)));
            }
            JSONArray optJSONArray = iconObject.optJSONArray(A00(77, 15, 126));
            if (optJSONArray != null) {
                for (int i = 0; i < optJSONArray.length(); i++) {
                    optJSONArray.put(i, c7h.A0K(optJSONArray.optString(i)));
                }
            }
            JSONArray optJSONArray2 = iconObject.optJSONArray(A00(43, 8, 26));
            if (optJSONArray2 != null) {
                for (int i2 = 0; i2 < optJSONArray2.length(); i2++) {
                    A04(optJSONArray2.optJSONObject(i2), c7h);
                }
            } else {
                A04(iconObject, c7h);
            }
    ...
    public static void A04(JSONObject imageObject, C7H c7h) throws JSONException {
        ...
        if (!TextUtils.isEmpty(imageObject.optString(A003))) {
            String A0M = c7h.A0M(imageObject.optString(A003));
            String[] strArr = A01;
