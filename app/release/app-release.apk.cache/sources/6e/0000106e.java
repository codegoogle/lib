-27, -37, -20, -41, -77, -32, -42, -60, -45, -26, -41, -96, -28, bx.j7, -26, -45, -26, -41, -42, -98, -110, 61, 51, 68, 47, Flags.CD, 56, 46, 28, 43, 62, 47, -8, 61, ax5.a, 58, 58, 57, 60, 62, -10, -22, 22, 12, 29, 8, -28, 17, 7, -11, 4, 23, 8, -47, 25, -26, 4, 19, 22, -44, -43, -50, -50, -59, -52, -59, -60, -115, -48, -52, -63, bx.l7, -62, -63, -61, -53, -4};
    }
    ...
    public C0604Di(String str, @Nullable String str2, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
                ...
                if (i3 < 26 || i <= 0) {
                    if (!A03(226, 10, 23).equals(str2) && !A03(121, 10, 22).equals(str2) && !A03(140, 12, 57).equals(str2) && !A03(211, 15, 119).equals(str2) && !A03(255, 12, 11).equals(str2) && !A03(236, 10, 110).equals(str2) && !A03(246, 9, 118).equals(str2)) {
                        ...
                        if (strArr3[0].length() != strArr3[5].length()) {
                            ...
                            if (!A03.equals(str2) && !A03(172, 15, 105).equals(str2) && !A03(187, 15, 4).equals(str2) && !A03(a.n, 9, 47).equals(str2)) {
                                if (A03(WKSRecord.Service.CISCO_TNA, 9, 31).equals(str2)) {
                                    i2 = 6;
    ...
    public static C0604Di A01(String str) {
        return new C0604Di(str, null, null, true, false, false);
    }

    public static C0604Di A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2) {
        return new C0604Di(str, str2, codecCapabilities, false, z, z2);
    }
    ...
    public static boolean A0A(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0726Ig.A02 >= 21 && A0B(codecCapabilities);
    }
    ...
    public static boolean A0C(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0726Ig.A02 >= 21 && A0D(codecCapabilities);
    }
    ...
    public final Point A0F(int widthAlignment, int heightAlignment) {
        ...
        return new Point(C0726Ig.A04(widthAlignment, widthAlignment2) * widthAlignment2, C0726Ig.A04(heightAlignment, heightAlignment2) * heightAlignment2);
    }
    ...
    public final boolean A0I(int i, int i2, double d) {
        ...
        if (videoCapabilities == null) {
            ...
            String A03 = A03(oq.j, 1, 40);
            if (i >= i2 || !A0E(videoCapabilities, i2, i, d)) {
                A07(A03(458, 21, 110) + i + A03 + i2 + A03 + d);
                return false;
            }
            A06(A03(437, 21, 22) + i + A03 + i2 + A03 + d);
            return true;
        } else {
            return true;
        }
    ...
    public final boolean A0J(String codecMimeType) {
        String A05;
        if (codecMimeType == null || this.A01 == null || (A05 = IJ.A05(codecMimeType)) == null) {
            return true;
        }
        boolean equals = this.A01.equals(A05);
        String A03 = A03(4, 2, 78);
        if (!equals) {
            A07(A03(324, 11, 20) + codecMimeType + A03 + A05);
            return false;
        }
        Pair<Integer, Integer> A02 = C0615Dt.A02(codecMimeType);
        if (A02 == null) {
            return true;
        }
        ...
        if (A08[7].charAt(21) != 'h') {
            ...
            A07(A03(335, 20, 102) + codecMimeType + A03 + A05);
            return false;
        }
        throw new RuntimeException();
    }
