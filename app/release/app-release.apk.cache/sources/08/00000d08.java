...
public interface DynamicLoader {
    ...
    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, @z1 NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView);

    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, @z1 NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView);
    ...
    NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @z1 NativeAdScrollView.AdViewProvider adViewProvider, int i, @z1 NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2);
