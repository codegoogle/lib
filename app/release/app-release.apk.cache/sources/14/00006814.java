...
public class yu4 extends xu4 {
    @tp4(version = "1.1")
    public static final <T> T p0(T t, T t2, T t3, @NotNull Comparator<? super T> comparator) {
        c25.p(comparator, "comparator");
        return (T) q0(t, q0(t2, t3, comparator), comparator);
    }

    @tp4(version = "1.1")
    public static final <T> T q0(T t, T t2, @NotNull Comparator<? super T> comparator) {
        c25.p(comparator, "comparator");
        return comparator.compare(t, t2) >= 0 ? t : t2;
    }

    @tp4(version = "1.4")
    public static final <T> T r0(T t, @NotNull T[] tArr, @NotNull Comparator<? super T> comparator) {
        c25.p(tArr, "other");
        c25.p(comparator, "comparator");
        for (T t2 : tArr) {
    ...
    @tp4(version = "1.1")
    public static final <T> T s0(T t, T t2, T t3, @NotNull Comparator<? super T> comparator) {
        c25.p(comparator, "comparator");
        return (T) t0(t, t0(t2, t3, comparator), comparator);
    }

    @tp4(version = "1.1")
    public static final <T> T t0(T t, T t2, @NotNull Comparator<? super T> comparator) {
        c25.p(comparator, "comparator");
        return comparator.compare(t, t2) <= 0 ? t : t2;
    }

    @tp4(version = "1.4")
    public static final <T> T u0(T t, @NotNull T[] tArr, @NotNull Comparator<? super T> comparator) {
        c25.p(tArr, "other");
        c25.p(comparator, "comparator");
        for (T t2 : tArr) {
            if (comparator.compare(t, t2) > 0) {
