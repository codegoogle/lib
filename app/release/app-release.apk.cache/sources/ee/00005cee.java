...
public final class sw4 implements uv4<yq4> {
    @Nullable
    private qp4<yq4> s;
    ...
    public final void b() {
        synchronized (this) {
            while (true) {
                qp4<yq4> qp4Var = this.s;
                if (qp4Var == null) {
                    c25.n(this, "null cannot be cast to non-null type java.lang.Object");
                    wait();
                } else {
                    rp4.n(qp4Var.o());
                }
    ...
    @Nullable
    public final qp4<yq4> c() {
        return this.s;
    }

    public final void d(@Nullable qp4<yq4> qp4Var) {
        this.s = qp4Var;
    }
