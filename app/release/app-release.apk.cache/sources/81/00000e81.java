...
public final class C5E implements NativeAdScrollViewApi {
    ...
    public C5E(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @Nullable NativeAdScrollView.AdViewProvider adViewProvider, int i, @Nullable NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2) {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i > 0) {
                ...
                if (this.A02 == null) {
                    if (i > 0) {
                        this.A05.A01(((int) C0795Le.A01) * i);
                    }
                } else {
                    this.A05.A01((int) (C0795Le.A01 * this.A02.getHeight()));
                }
