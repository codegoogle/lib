...
public class vn1<T> implements Parcelable {
    ...
    /* compiled from: ClassSpec.java */
    /* loaded from: classes2.dex */
    public class a implements Parcelable.Creator<vn1> {
        @Override // android.os.Parcelable.Creator
        /* renamed from: a */
        public vn1 createFromParcel(@x1 Parcel parcel) {
    ...
    @x1
    public static <T> vn1<T> d(@x1 Class<T> cls, @z1 Object... objArr) {
        Gson gson = new Gson();
        rv2 rv2Var = new rv2();
        ...
        return new vn1<>(cls.getName(), rv2Var);
    }
    ...
    @x1
    public <R> vn1<R> c(@x1 Class<R> cls) {
        try {
            Class<?> i = i();
    ...
    public boolean equals(Object obj) {
        ...
        vn1 vn1Var = (vn1) obj;
        if (this.s.equals(vn1Var.s) && r81.d(this.t, vn1Var.t)) {
            return r81.d(this.u, vn1Var.u);
        }
        return false;
    }
    ...
    @r2
    public vn1(@x1 String str, @x1 rv2 rv2Var) {
        this.s = str;
        this.t = rv2Var;
    }

    public vn1(@x1 Parcel parcel) {
