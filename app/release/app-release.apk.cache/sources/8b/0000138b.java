...
public final class C0936Qq implements AnonymousClass03<Bitmap> {
    public static byte[] A06;
    public static String[] A07;
    public final int A00;
    public final int A01;
    public final String A02 = C0936Qq.class.getSimpleName();
    ...
    public C0936Qq(int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A00 = i2;
        this.A05 = z;
        this.A03 = z2;
    ...
    public final AnonymousClass02<Bitmap> A3E(File file, C0M c0m) {
        ...
        try {
            Bitmap A03 = C0N.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
            if (A03 != null) {
                return new AnonymousClass02<>(true, A03);
            }
            c0m.A7w(new C0941Qv(A01(4, 14, 77)));
            return A00(null);
        } catch (Throwable th) {
            if (A07[6].length() != 26) {
                String[] strArr = A07;
    ...
    @Override // com.facebook.ads.redexgen.X.AnonymousClass03
    @SuppressLint({"CatchGeneralException"})
    public final void A4B(File file, C0M c0m) throws C0941Qv {
        if (this.A03) {
            try {
                Bitmap A03 = C0N.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
                if (A03 != null) {
                ...
                c0m.A85(th);
                throw new C0941Qv(A01(18, 33, 49), th);
            }
        }
    }
}